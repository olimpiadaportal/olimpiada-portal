...
export const messages: Record<Locale, Record<string, string>> = {
  "az": {
    ...
    "link.subtitle": "Uşaq artıq başqa valideyn tərəfindən yaradılıbsa, profili yaradan valideyndən dəvət kodu istəyin. Kodu daxil etdiyiniz anda giriş açılır — təsdiq gözləmək lazım deyil.",
    "link.childId": "Uşağın ID-si",
    "link.enterCode.title": "Dəvət kodunu daxil edin",
    "link.enterCode.body": "Profili yaradan valideyn sizin üçün birdəfəlik dəvət kodu yaradır. Kodu və uşağın 8 rəqəmli ID-sini ondan alın.",
  ...
  "en": {
    ...
    "link.subtitle": "If another parent already created the child, ask them for an invitation code. Access opens the moment you enter it — there is nothing to approve and nothing to wait for.",
    "link.childId": "Child's 8-digit ID",
    "link.enterCode.title": "Enter the invitation code",
    "link.enterCode.body": "The parent who created the profile generates a single-use code for you. Ask them for the code and the child's 8-digit ID.",
  ...
  "ru": {
    ...
    "link.subtitle": "Если ребёнка уже создал другой родитель, попросите у него код приглашения. Доступ открывается сразу после ввода кода — ничего подтверждать и ждать не нужно.",
    "link.childId": "8-значный ID ребёнка",
    "link.enterCode.title": "Введите код приглашения",
    "link.enterCode.body": "Родитель, создавший профиль, создаёт для вас одноразовый код. Попросите у него код и 8-значный ID ребёнка.",
