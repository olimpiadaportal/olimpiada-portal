...
export const messages: Record<Locale, Record<string, string>> = {
  "az": {
    ...
    "pricing.sibling": "Avtomatik qardaş/bacı endirimi: 2-ci uşaq −10%, 3-cü və sonrakı −15%.",
    "pricing.promo": "Başlanğıcda təqdimat kampaniyası olur; qiymətlər nümunəvidir və platforma tərəfindən təyin olunur.",
    "pricing.note": "Yalnız valideyn ödəniş edə bilər. Uşaqlar qiymət və ödənişləri görmür.",
    ...
    "parent.child.passwordHint": "Ən az 8 simvol. Uşağınız bunu 8 rəqəmli ID ilə birlikdə istifadə edir.",
    ...
    "pay.total": "Cəmi",
    "pricing.intro": "Hər fənn üçün sadə qiymət, hər uşaq üzrə. İstədiyiniz qədər fənn seçin — qiymət avtomatik hesablanır.",
    "pricing.subjectsNote": "Qiymət hər fənn və hər uşaq üzrədir. Riyaziyyat, Elm, Məntiq və İngilis dilini ayrıca seçə bilərsiniz.",
    ...
    "pricing.siblingBody": "Birdən çox uşaq əlavə etdikdə endirim avtomatik tətbiq olunur: 2-ci uşaq üçün −10%, 3-cü və sonrakı uşaqlar üçün −15%. Heç bir kod lazım deyil.",
    "pricing.disclaimer": "Qeyd: göstərilən qiymətlər nümunəvidir (placeholder) və yekun deyil. Son qiymətlər platforma tərəfindən təsdiqlənəcək.",
    ...
    "privacy.s8.statusOff": "Hazırkı vəziyyət: platformada ödənişlər söndürülüb və hələ heç bir ödəniş təminatçısı inteqrasiya olunmayıb. Ödənişlər söndürülü olduğu müddətdə mobil tətbiqin heç bir yerində qiymət göstərilmir.",
    "privacy.s8.statusOn": "Hazırkı vəziyyət: ödənişlər aktivdir və yalnız veb saytda, bankın öz ödəniş səhifəsi vasitəsilə həyata keçirilir. Mobil tətbiq valideynə və ya hesabı olmayan ziyarətçiyə abunə qiymətlərini yalnız məlumat üçün göstərə bilər; şagird sessiyasında qiymət heç vaxt göstərilmir və tətbiqin özündə alış tamamlana bilmir.",
  ...
  "en": {
    ...
    "pricing.promo": "A launch promotion runs at start; prices are illustrative and set by the platform.",
    ...
    "parent.child.passwordHint": "At least 8 characters. Your child uses this with their 8-digit ID.",
    ...
    "pay.total": "Total",
    "pricing.intro": "Simple per-subject pricing, per child. Add as many subjects as you like — the total is calculated automatically.",
    "pricing.subjectsNote": "Pricing is per subject, per child. You can choose Math, Science, Logic and English independently.",
    ...
    "pricing.siblingBody": "When you add more than one child, the discount is applied automatically: −10% for the 2nd child, −15% for the 3rd and beyond. No code required.",
    "pricing.disclaimer": "Note: the prices shown are placeholders and not final. Final pricing will be confirmed by the platform.",
    ...
    "privacy.s8.statusOff": "Current status: payments are switched off on the platform and no payment provider has been integrated yet. While payments are off, no price is displayed anywhere in the mobile app.",
    "privacy.s8.statusOn": "Current status: payments are live and happen only on the website, through the bank's own hosted payment page. The mobile app may show subscription prices for information to a parent or a signed-out visitor; a student session never shows a price, and no purchase can be completed inside the app.",
  ...
  "ru": {
    ...
    "pricing.promo": "На старте действует акция; цены ориентировочные и устанавливаются платформой.",
    ...
    "parent.child.passwordHint": "Не менее 8 символов. Ребёнок использует его вместе с 8-значным ID.",
    ...
    "pay.discount": "Скидка",
    "pay.total": "Итого",
    "pricing.intro": "Простая цена за каждый предмет — для каждого ребёнка. Добавляйте сколько угодно предметов: итог рассчитывается автоматически.",
    "pricing.subjectsNote": "Цена — за предмет и за ребёнка. Математику, науку, логику и английский можно выбирать по отдельности.",
    ...
    "pricing.siblingBody": "Когда вы добавляете больше одного ребёнка, скидка применяется автоматически: −10% за 2-го ребёнка и −15% за 3-го и последующих. Промокод не нужен.",
    "pricing.disclaimer": "Примечание: указанные цены ориентировочные и не являются окончательными. Итоговые цены будут подтверждены платформой.",
    ...
    "privacy.s8.statusOff": "Текущее состояние: платежи на платформе отключены, и ни один платёжный провайдер пока не подключён. Пока платежи отключены, цены не показываются ни в одном разделе мобильного приложения.",
    "privacy.s8.statusOn": "Текущее состояние: платежи работают и проходят только на сайте, через собственную платёжную страницу банка. Мобильное приложение может показывать цены подписки для информации родителю или посетителю без аккаунта; в сессии ученика цены не показываются никогда, и завершить покупку внутри приложения нельзя.",
