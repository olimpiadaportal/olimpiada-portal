...
interface FlowFieldBackgroundProps {
  ...
  trailOpacity?: number;
  /**
   * Number of particles. Default: 200 (optimized for performance)
   */
  ...
  speed?: number;
  /**
   * Background color for the canvas fade effect.
   * Default: "rgba(0, 0, 0, {trailOpacity})"
   */
...
export default function FlowFieldBackground({
  ...
  }, [color, trailOpacity, particleCount, speed, backgroundColor, prefersReducedMotion]);
