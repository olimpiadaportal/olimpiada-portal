// Plain shared module for subscription pricing (importable from both the
// "use server" actions and the client price cell — no server-only imports here).
//
// It used to live at app/(protected)/pricing/shared.ts. The Subscription
// Pricing SCREEN was folded into /manage/subjects (2026-09-10), and a module
// eight other files import must not sit inside a route directory that no longer
// renders anything — deleting the route would have taken the parser for money
// with it.
