// Route-level skeleton for /bug-reports. Every filter, search keystroke and
// page change navigates (the URL is the source of truth), so this is the
...
// there is no components/skeletons library in this repo to import from, and
// question-reports/loading.tsx uses exactly these classes. Purely
// presentational, no text to translate.
