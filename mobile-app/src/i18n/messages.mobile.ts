...
export const mobileMessages: Record<Locale, Record<string, string>> = {
  az: {
    ...
    "mob.addchild.idPending": "Övladın profili yaradıldı. 8 rəqəmli giriş ID-si fənn abunəliyi aktivləşən kimi burada görünəcək.",
  ...
  en: {
    ...
    "mob.addchild.idPending": "Your child's profile is created. The 8-digit login ID appears here as soon as a subject subscription is active.",
  ...
  ru: {
    ...
    "mob.addchild.idPending": "Профиль ребёнка создан. 8-значный ID для входа появится здесь, как только подписка на предмет станет активной.",
