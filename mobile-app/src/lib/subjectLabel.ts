// ONE reusable, locale-aware subject label resolver (web parity).
//
...
//
// Pure (no store/hook deps) so screens pass the t() they already have from
// useT(). createT() returns the KEY STRING itself for unknown keys — that is
