...
export const messages: Record<Locale, Record<string, string>> = {
  "az": {
    ...
    "faq.a7": "Bəli. Qardaş/bacı endirimi avtomatik tətbiq olunur: 2-ci uşaq üçün −10%, 3-cü və sonrakı uşaqlar üçün −15%. Heç bir kod daxil etmək lazım deyil.",
  ...
  "en": {
    ...
    "faq.a7": "Yes. A sibling discount is applied automatically: −10% for the 2nd child and −15% for the 3rd and beyond. No code needs to be entered.",
  ...
  "ru": {
    ...
    "faq.a7": "Да. Скидка за нескольких детей применяется автоматически: −10% за 2-го ребёнка и −15% за 3-го и последующих. Промокод вводить не нужно.",
