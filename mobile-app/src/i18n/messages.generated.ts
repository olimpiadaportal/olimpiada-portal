...
export const messages: Record<Locale, Record<string, string>> = {
  "az": {
    ...
    "subjedit.billingExplainer": "Fənn əlavə etdikdə cari dövrün qalan günləri üçün mütənasib məbləğ ödəyirsiniz, tam yeni tarif isə növbəti yenilənmədən başlayır; fənni sildikdə isə geri ödəniş olmur — fənn dövrün sonuna qədər aktiv qalır və plan yalnız bundan sonra ucuzlaşır.",
    "subjedit.dueNow": "İndi ödəniləcək",
    "subjedit.thenRate": "Sonra: {date} tarixindən etibarən {total} {currency} / {interval}",
    "subjedit.noChargeNow": "İndi heç nə ödəmirsiniz — yeni tarif ({total} {currency} / {interval}) {date} tarixindən başlayacaq.",
    "subjedit.removalNotice": "Silinən fənn(lər) {date} tarixinə qədər aktiv qalacaq, bundan sonra plan {total} {currency} / {interval} səviyyəsinə düşəcək — geri ödəniş edilmir.",
  ...
  "en": {
    ...
    "subjedit.billingExplainer": "Adding a subject mid-cycle only charges the days left in the current period — the full new rate starts at your next renewal; removing gives no refund, the subject just stays active until the period ends and the plan gets cheaper from then on.",
    "subjedit.dueNow": "Due now",
    "subjedit.thenRate": "Then: {total} {currency} / {interval} from {date}",
    "subjedit.noChargeNow": "No charge now — the new rate ({total} {currency} / {interval}) starts on {date}.",
    "subjedit.removalNotice": "Removed subject(s) stay active until {date}, then the plan drops to {total} {currency} / {interval} — no refund.",
  ...
  "ru": {
    ...
    "subjedit.billingExplainer": "При добавлении предмета в середине периода вы платите только за оставшиеся дни — полная новая цена начинает действовать со следующего продления; при удалении возврата средств нет — предмет остаётся активным до конца периода, а тариф снижается только после этого.",
    "subjedit.dueNow": "К оплате сейчас",
    "subjedit.thenRate": "Далее: {total} {currency} / {interval} с {date}",
    "subjedit.noChargeNow": "Сейчас плата не взимается — новый тариф ({total} {currency} / {interval}) начнёт действовать с {date}.",
    "subjedit.removalNotice": "Удаляемые предметы останутся активными до {date}, после чего тариф снизится до {total} {currency} / {interval} — без возврата средств.",
