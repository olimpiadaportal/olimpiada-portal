...
export const messages: Record<Locale, Record<string, string>> = {
  az: {
    ...
    "billing.giveawayNote": "Pulsuz kampaniya dövründə bütün funksiyalar ödənişsizdir — ödəniş tələb olunmur.",
    ...
    "pricing2.monthly.b3": "Həftəlik plana nisbətən təxminən 25% qənaət",
    "pricing2.monthly.cta": "Aylıq planı seç",
    "pricing2.yearly.name": "İllik",
    "pricing2.yearly.price": "≈ 50 AZN",
    ...
    "pricing2.yearly.b3": "Aylıq plana nisbətən təxminən 30% qənaət",
    ...
    "nav.olympiad": "Olimpiada hazırlığı",
    "nav.news": "Xəbərlər",
    "nav.about": "Haqqında",
    "nav.faq": "FAQ",
    "nav.contact": "Əlaqə",
    ...
    "oly.title": "Olimpiada Hazırlığı",
    "oly.lead": "Olimpiadalara hazırlaşmaq üçün xüsusi əlavə.",
    "oly.p1":
      "Valideyn olimpiada paketini bir dəfə alır; uşaq ömürlük girişi saxlayır.",
    "oly.lifetime": "Ömürlük giriş",
    "oly.attempt":
      "Hər cəhd 25 sualdır, avtomatik seçilir — şagird çətinliyi seçmir.",
    "oly.note": "Paketlər komandamız tərəfindən hazırlanır və vaxtaşırı yenilənir.",
    ...
    "pricing.plan.weekly.price": "≈ 2 AZN",
  ...
  en: {
    ...
    "billing.giveawayNote": "During the free giveaway period every feature is free of charge — no payment is required.",
    ...
    "pricing2.monthly.b3": "Around 25% savings vs weekly",
    ...
    "pricing2.yearly.b3": "Around 30% savings vs monthly",
    ...
    "oly.title": "Olympiad Preparation",
    "oly.lead": "A dedicated add-on to train for olympiads.",
    "oly.p1": "Parents purchase an olympiad package once; the child keeps lifetime access.",
    "oly.lifetime": "Lifetime access",
    "oly.attempt":
      "Each attempt is 25 questions, selected automatically — students never choose difficulty.",
    "oly.note": "Packages are prepared by our team and updated over time.",
    ...
    "pricing.plan.monthly.save": "Save ≈ 25% vs weekly",
    ...
    "pricing.plan.yearly.save": "Save ≈ 30% vs monthly",
  ...
  ru: {
    ...
    "billing.giveawayNote": "В период бесплатной акции все функции доступны бесплатно — оплата не требуется.",
    ...
    "pricing2.monthly.b3": "Экономия около 25% по сравнению с недельным",
    ...
    "pricing2.yearly.b3": "Экономия около 30% по сравнению с месячным",
    ...
    "nav.pricing": "Цены",
    "nav.olympiad": "Подготовка к олимпиадам",
    "nav.news": "Новости",
    "nav.about": "О нас",
    "nav.faq": "FAQ",
    ...
    "oly.title": "Подготовка к олимпиадам",
    "oly.lead": "Отдельное дополнение для тренировки к олимпиадам.",
    "oly.p1": "Родитель покупает пакет один раз; у ребёнка остаётся пожизненный доступ.",
    "oly.lifetime": "Пожизненный доступ",
    "oly.attempt":
      "Каждая попытка — 25 вопросов, подбираются автоматически; ученик не выбирает сложность.",
    "oly.note": "Пакеты готовит наша команда и со временем обновляет.",
    ...
    "pricing.plan.monthly.save": "Экономия ≈ 25% против недельной",
    ...
    "pricing.plan.yearly.save": "Экономия ≈ 30% против месячной",
