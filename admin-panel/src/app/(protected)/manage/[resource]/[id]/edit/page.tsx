...
// Generic edit screen for the registry resources (grades, subjects, olympiad
// types). Round 52: the topics/subtopics branches (exam-scope 404 guard and the
// parent-topic term map) went away with those resources — they are edited on
// the Curriculum Structure screen (/curriculum) now, which enforces the same
// scope rule inside its own guarded actions.
