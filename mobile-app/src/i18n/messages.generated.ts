...
export const messages: Record<Locale, Record<string, string>> = {
  "az": {
    ...
    "subjedit.nextBillingLine": "{date} tarixindən etibarən abunəniz {total} {currency} / {interval} olacaq.",
    "subjedit.noteLabel": "Qeyd",
    "subjedit.noteText": "Silinən fənn(lər) {date} tarixinə qədər aktiv qalır. Həmin tarixdən abunəniz yenilənmiş fənlərlə avtomatik davam edəcək. Silinən fənlərə görə geri ödəniş edilmir.",
    "subjedit.noChargeNow": "İndi heç nə ödəmirsiniz — dəyişiklik {date} tarixindən qüvvəyə minir.",
    "subjedit.noteLine": "{subject} {date} tarixinə qədər aktiv qalır.",
    "subjedit.noteNoRefund": "Həmin tarixdən sonra abunəniz yenilənmiş fənlərlə avtomatik davam edir. Silinən fənlərə görə geri ödəniş edilmir.",
    ...
    "bug.intro": "Nə baş verdiyini qısaca yazın. Nə qədər ətraflı yazsanız, o qədər tez düzəldə bilərik.",
    ...
    "bug.contextNote": "Səhifənin ünvanı, dil və brauzer məlumatı avtomatik əlavə olunur.",
    ...
    "bug.successBody": "Təşəkkür edirik. Komandamız bildirişinizi araşdıracaq və lazım olsa sizinlə əlaqə saxlayacaq.",
    "bug.emptyErr": "Başlıq ən azı 3, izah isə ən azı 10 simvol olmalıdır.",
    "bug.err.tooLong": "Mətn həddindən artıq uzundur. Qısaldıb yenidən cəhd edin.",
    "bug.err.tooMany": "Qısa müddətdə çox bildiriş göndərdiniz. Bir azdan yenidən cəhd edin.",
  ...
  "en": {
    ...
    "subjedit.nextBillingLine": "Starting from {date}, your subscription will be {total} {currency} / {interval}.",
    "subjedit.noteLabel": "Note",
    "subjedit.noteText": "The removed subject(s) remain active until {date}. After that date, your subscription automatically continues with the updated subjects. No refund is issued for removed subjects.",
    "subjedit.noChargeNow": "Nothing to pay now — the change takes effect on {date}.",
    "subjedit.noteLine": "{subject} stays active until {date}.",
    "subjedit.noteNoRefund": "After that your subscription continues automatically with the updated subjects. No refund is issued for removed subjects.",
    ...
    "bug.intro": "Tell us briefly what went wrong. The more detail you give, the faster we can fix it.",
    ...
    "bug.contextNote": "The page address, your language and browser details are attached automatically.",
    ...
    "bug.successBody": "Thank you. Our team will look into your report and get back to you if we need more details.",
    "bug.emptyErr": "The title needs at least 3 characters and the description at least 10.",
    "bug.err.tooLong": "That text is too long. Please shorten it and try again.",
    "bug.err.tooMany": "You've sent too many reports in a short time. Please try again a little later.",
  ...
  "ru": {
    ...
    "subjedit.nextBillingLine": "С {date} ваша подписка составит {total} {currency} / {interval}.",
    "subjedit.noteLabel": "Примечание",
    "subjedit.noteText": "Удалённые предметы остаются активными до {date}. После этой даты подписка автоматически продолжится с обновлёнными предметами. Возврат за удалённые предметы не производится.",
    "subjedit.noChargeNow": "Сейчас платить не нужно — изменение вступит в силу {date}.",
    "subjedit.noteLine": "«{subject}» остаётся активным до {date}.",
    "subjedit.noteNoRefund": "После этого подписка автоматически продолжится с обновлёнными предметами. Возврат за удалённые предметы не производится.",
    ...
    "bug.intro": "Кратко опишите, что пошло не так. Чем больше подробностей, тем быстрее мы всё исправим.",
    ...
    "bug.contextNote": "Адрес страницы, язык и данные браузера прикрепляются автоматически.",
    ...
    "bug.successBody": "Спасибо. Наша команда изучит ваше сообщение и свяжется с вами, если понадобятся детали.",
    "bug.emptyErr": "В заголовке нужно минимум 3 символа, в описании — минимум 10.",
    "bug.err.tooLong": "Текст слишком длинный. Сократите его и попробуйте снова.",
    "bug.err.tooMany": "Вы отправили слишком много сообщений за короткое время. Попробуйте чуть позже.",
