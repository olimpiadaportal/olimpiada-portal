...
export const messages: Record<Locale, Record<string, string>> = {
  az: {
    ...
    "auth.child.err.passwordTooShort": "Parol 8–128 simvol arasında olmalıdır.",
    "auth.child.err.passwordWeak":
      "Parolda ən azı bir böyük hərf və bir xüsusi simvol (!, ?, # kimi) olmalıdır.",
    "auth.child.err.nameTooLong": "Ad çox uzundur (maksimum 80 simvol).",
    "auth.child.err.passwordEqualsId": "Parol ID ilə eyni ola bilməz.",
    "auth.child.err.noLoginId":
      "Bu uşağın hələ 8 rəqəmli giriş ID-si yoxdur, ona görə parol təyin etmək olmur. Zəhmət olmasa dəstəklə əlaqə saxlayın.",
    ...
    "auth.child.err.creatorOnly":
      "Uşağın parolunu yalnız hesabı yaradan valideyn dəyişə bilər.",
    ...
    "reset.hint":
      "Hesabınız üçün yeni şifrə daxil edin: ən azı 8 simvol, bir böyük hərf və bir xüsusi simvol (!, ?, # kimi).",
    ...
    "parent.err.password": "Parol 8–128 simvol arasında olmalıdır.",
    ...
    "link.choice.existingBody": "Başqa valideynin yaratdığı uşaq profilinə qoşulun. Yenidən ödəniş tələb olunmur.",
    "link.title": "Mövcud uşaq profilinə giriş əldə et",
    // TWO ROUTES IN, NEITHER OF THEM APPROVED (migration 180). The invite code
    // came back on 2026-09-17 alongside the credential route it was replaced by
    // in 177 — but redeeming now CREATES the link, so nothing here may promise
    // a review, a request or a wait. link.pending / link.approve / link.reject
    // were deleted rather than left unused: three ready-made approval strings
    // are how a future round rebuilds the flow that completed zero links.
    "link.subtitle":
      "Uşaq artıq başqa valideyn tərəfindən yaradılıbsa, profilə iki yoldan biri ilə qoşula bilərsiniz. Hər iki halda giriş dərhal açılır — təsdiq gözləmək lazım deyil.",
    "link.childId": "Uşağın ID-si",
    "link.way.credentials": "Uşağın ID-si və parolu ilə",
    "link.way.credentialsBody": "Uşağın 8 rəqəmli ID-sini və parolunu bilirsinizsə, bu yolu seçin.",
    "link.way.code": "Uşağın ID-si və dəvət kodu ilə",
    "link.way.codeBody":
      "Profili yaradan valideyn sizin üçün dəvət kodu yarada bilər. Kodu və uşağın ID-sini ondan soruşun.",
    "link.code": "Dəvət kodu",
    "link.codeHint": "Kod birdəfəlikdir və 72 saatdan sonra etibarsız olur. Bu yolda parol tələb olunmur.",
    "link.request": "Giriş əldə et",
    "link.manage": "Girişi idarə et",
    "link.issue": "Dəvət kodu yarat",
    "link.issueHint":
      "Digər valideyn üçün birdəfəlik kod yaradın. Kodu və uşağın ID-sini ona verin — o, profilə dərhal qoşulacaq.",
    "link.issueReplaces": "Yeni kod yaratsanız, əvvəlki kod dərhal etibarsız olur.",
    "link.codeReady": "Bu kodu və uşağın ID-sini digər valideynlə paylaşın. Kod 72 saat ərzində etibarlıdır.",
    "link.codeExpires": "Etibarlıdır:",
    "link.copyCode": "Dəvət kodunu kopyala",
    "link.revoke": "Girişi ləğv et",
    "link.leave": "Bu uşaqdan ayrıl",
    "link.linked": "Ortaq giriş aktivdir",
    "link.owner": "Hesab sahibi",
    "link.noAdults": "Hələ başqa valideyn qoşulmayıb.",
    "link.success": "Dəyişiklik yadda saxlanıldı.",
    "link.err.forbidden": "Bu əməliyyat üçün icazəniz yoxdur.",
    "link.err.invalid": "Məlumatları yoxlayın və yenidən cəhd edin.",
    "link.err.invalidInvite": "Uşaq ID-si və ya dəvət kodu yanlışdır və ya vaxtı bitib.",
    "link.err.alreadyLinked": "Bu uşaq artıq hesabınıza bağlıdır.",
    "link.err.unavailable": "Bu dəvət artıq mövcud deyil.",
    "link.err.creatorOnly": "Bu əməliyyatı yalnız hesab sahibi edə bilər.",
    "link.err.limit": "Bu uşaq üçün maksimum 4 böyüyə giriş verilə bilər.",
    "link.err.needsId": "Əvvəlcə uşaq üçün giriş ID-si yaradılmalıdır.",
    ...
    "parent.child.passwordHint":
      "Ən azı 8 simvol, bir böyük hərf və bir xüsusi simvol (!, ?, # kimi). Uşağınız bunu 8 rəqəmli ID ilə birlikdə istifadə edir.",
    ...
    "parent.child.idCopy": "Kopyalamaq üçün toxunun",
    "parent.child.idCopied": "Kopyalandı",
    "parent.child.idCopyA11y": "Giriş ID-sini kopyala",
    "parent.child.idNote":
    ...
    // ---- 1-day Free Trial (migrations 139-141) ------------------------------
    "trial.hero.title": "1 günlük pulsuz giriş",
    "trial.hero.body":
      "Abunə olmadan öncə platformanı sınayın. 2 fənnə 24 saat tam pulsuz giriş — kart tələb olunmur.",
    "trial.hero.duration": "24 saat",
    "trial.hero.p1": "24 saat limitsiz giriş",
    "trial.hero.p2": "İstədiyiniz 2 fənni seçin",
    "trial.hero.p3": "Testləri əvvəlcədən yoxlayın",
    "trial.hero.p4": "Nəticələr bal və reytinqə təsir etmir",
    "trial.cta.activate": "Pulsuz girişi aktivləşdir",
    "trial.cta.pending": "Aktivləşdirilir…",
    "trial.pick.title": "2 fənn seçin",
    "trial.pick.hint": "Pulsuz giriş üçün ən çoxu 2 fənn seçə bilərsiniz.",
    "trial.pick.cap": "Ən çoxu 2 fənn seçin",
    "trial.pick.selected": "Seçildi",
    "trial.pick.locked": "Ən çoxu 2 fənn seçin",
    "trial.pick.aria.select": "{subject} fənnini seç",
    "trial.pick.aria.selected": "{subject} — seçilib",
    "trial.pick.done": "Əla! 2 fənninizi seçdiniz.",
    "trial.summary.title": "Pulsuz girişiniz",
    "trial.summary.count": "{n} / 2 seçildi",
    "trial.summary.endsAt": "Bitmə vaxtı: {when}",
    "trial.confirm.title": "Pulsuz girişi aktivləşdirmək?",
    "trial.confirm.body":
      "{child} üçün bu 2 fənnə 24 saatlıq giriş açılacaq. Bu, hər uşaq üçün yalnız bir dəfə mümkündür.",
    "trial.confirm.ok": "Bəli, aktivləşdir",
    "trial.confirm.cancel": "İmtina",
    "trial.done.title": "Pulsuz girişiniz aktivdir",
    "trial.done.body": "{child} indi bu fənlərə limitsiz giriş əldə etdi:",
    "trial.done.next": "Öyrənməyə başla",
    "trial.status.active": "Pulsuz giriş aktivdir",
    "trial.status.endsIn": "Bitməsinə qalıb:",
    "trial.badge.active": "PULSUZ GİRİŞ",
    "trial.time.h": "s",
    "trial.time.m": "d",
    "trial.time.s": "san",
    "trial.expired.title": "Pulsuz giriş başa çatdı",
    "trial.expired.body":
      "24 saatlıq pulsuz girişiniz bitdi. Öyrənməyə davam etmək üçün abunəlik seçin.",
    "trial.expired.cta": "Abunəlik planlarına bax",
    "trial.used.note": "Bu uşaq üçün pulsuz girişdən artıq istifadə olunub.",
    "trial.note.unrated":
      "Pulsuz giriş müddətindəki nəticələr bala, reytinqə və statistikaya təsir etmir.",
    "trial.err.alreadyUsed": "Bu uşaq üçün pulsuz girişdən artıq istifadə olunub.",
    "trial.err.tooMany": "Ən çoxu 2 fənn seçə bilərsiniz.",
    "trial.err.noSubjects": "Ən azı 1 fənn seçin.",
    "trial.err.badSubject": "Seçilmiş fənn mövcud deyil.",
    "trial.err.alreadyFree": "Bu uşağın girişi onsuz da pulsuzdur.",
    "trial.err.alreadyCovered": "Seçdiyiniz fənlərdən biri artıq aktivdir.",
    "trial.err.generic": "Pulsuz giriş aktivləşdirilə bilmədi. Yenidən cəhd edin.",
    "access.freeTrial": "Pulsuz giriş",
    ...
    "subj.elm": "Elm",
    "subj.fizika": "Fizika",
    "subj.azerbaycan_dili": "Azərbaycan dili",
    ...
    "profile.err.passwordShort": "Yeni şifrə 8–128 simvol arasında olmalıdır.",
    "profile.err.passwordWeak":
      "Şifrədə ən azı bir böyük hərf və bir xüsusi simvol (!, ?, # kimi) olmalıdır.",
    ...
    "childedit.err.creatorOnly":
      "Uşağın şəklini yalnız hesabı yaradan valideyn dəyişə bilər.",
  ...
  en: {
    ...
    "auth.child.err.passwordTooShort": "Password must be 8 to 128 characters long.",
    "auth.child.err.passwordWeak":
      "The password needs at least one capital letter and one special character (such as !, ? or #).",
    ...
    "auth.child.err.noLoginId":
      "This child does not have an 8-digit login ID yet, so a password cannot be set. Please contact support.",
    ...
    "auth.child.err.creatorOnly":
      "Only the parent who created this child’s account can change the password.",
    ...
    "reset.hint":
      "Enter a new password for your account: at least 8 characters, with one capital letter and one special character (such as !, ? or #).",
    ...
    "parent.err.password": "Password must be 8 to 128 characters long.",
    "parent.err.passwordWeak":
      "The password needs at least one capital letter and one special character (such as !, ? or #).",
    "parent.err.tooMany":
    ...
    "link.choice.existingBody": "Join a child profile another parent already created. No second payment is required.",
    "link.title": "Get access to an existing child profile",
    "link.subtitle":
      "If another parent already created the child, there are two ways to join the profile. Either way access opens immediately — there is nothing to approve and nothing to wait for.",
    "link.childId": "Child's 8-digit ID",
    "link.way.credentials": "With the child's ID and password",
    "link.way.credentialsBody": "Use this if you already know the child's 8-digit ID and their password.",
    "link.way.code": "With the child's ID and an invitation code",
    "link.way.codeBody":
      "The parent who created the profile can generate an invitation code for you. Ask them for the code and the child's ID.",
    "link.code": "Invitation code",
    "link.codeHint": "The code is single-use and stops working after 72 hours. No password is needed for this route.",
    "link.request": "Get access",
    "link.manage": "Manage access",
    "link.issue": "Create invitation code",
    "link.issueHint":
      "Create a single-use code for the other parent. Give them the code and the child's ID and they join the profile straight away.",
    "link.issueReplaces": "Creating a new code makes the previous one stop working immediately.",
    "link.codeReady": "Share this code and the child's ID with the other parent. It expires in 72 hours.",
    "link.codeExpires": "Valid until:",
    "link.copyCode": "Copy the invitation code",
    "link.revoke": "Remove access",
    "link.leave": "Leave this child",
    "link.linked": "Shared access is active",
    "link.owner": "Account owner",
    "link.noAdults": "No other parent is linked yet.",
    "link.success": "The change was saved.",
    "link.err.forbidden": "You do not have permission for this action.",
    "link.err.invalid": "Check the information and try again.",
    "link.err.invalidInvite": "The child ID or invitation code is incorrect or expired.",
    "link.err.alreadyLinked": "This child is already linked to your account.",
    "link.err.unavailable": "This invitation is no longer available.",
    "link.err.creatorOnly": "Only the account owner can perform this action.",
    "link.err.limit": "A maximum of 4 adults can access this child.",
    "link.err.needsId": "A login ID must be created for the child first.",
    ...
    "parent.child.passwordHint":
      "At least 8 characters, with one capital letter and one special character (such as !, ? or #). Your child uses this with their 8-digit ID.",
    ...
    "parent.child.idCopy": "Tap to copy",
    "parent.child.idCopied": "Copied",
    "parent.child.idCopyA11y": "Copy the login ID",
    "parent.child.idNote":
    ...
    // ---- 1-day Free Trial (migrations 139-141) ------------------------------
    "trial.hero.title": "1-day free access",
    "trial.hero.body":
      "Try the platform before you subscribe. Full access to 2 subjects for 24 hours — no card needed.",
    "trial.hero.duration": "24 hours",
    "trial.hero.p1": "24 hours of unlimited access",
    "trial.hero.p2": "Choose any 2 subjects",
    "trial.hero.p3": "Try the tests before you buy",
    "trial.hero.p4": "Results do not affect scores or rankings",
    "trial.cta.activate": "Activate free access",
    "trial.cta.pending": "Activating…",
    "trial.pick.title": "Choose 2 subjects",
    "trial.pick.hint": "You can pick up to 2 subjects for the free day.",
    "trial.pick.cap": "Select maximum 2 subjects",
    "trial.pick.selected": "Selected",
    "trial.pick.locked": "Select maximum 2 subjects",
    "trial.pick.aria.select": "Select {subject}",
    "trial.pick.aria.selected": "{subject} — selected",
    "trial.pick.done": "Great! You have chosen your 2 subjects.",
    "trial.summary.title": "Your free access",
    "trial.summary.count": "{n} / 2 selected",
    "trial.summary.endsAt": "Ends: {when}",
    "trial.confirm.title": "Activate free access?",
    "trial.confirm.body":
      "{child} will get 24 hours of access to these 2 subjects. This is available only once per child.",
    "trial.confirm.ok": "Yes, activate",
    "trial.confirm.cancel": "Cancel",
    "trial.done.title": "Your free access is active",
    "trial.done.body": "{child} now has unlimited access to:",
    "trial.done.next": "Start learning",
    "trial.status.active": "Free access is active",
    "trial.status.endsIn": "Ends in:",
    "trial.badge.active": "FREE ACCESS",
    "trial.time.h": "h",
    "trial.time.m": "m",
    "trial.time.s": "s",
    "trial.expired.title": "Free access has ended",
    "trial.expired.body":
      "Your 24 hours of free access have ended. Choose a subscription to keep learning.",
    "trial.expired.cta": "View subscription plans",
    "trial.used.note": "The free access for this child has already been used.",
    "trial.note.unrated":
      "Results during free access do not affect scores, rankings or statistics.",
    "trial.err.alreadyUsed": "The free access for this child has already been used.",
    "trial.err.tooMany": "You can choose at most 2 subjects.",
    "trial.err.noSubjects": "Choose at least 1 subject.",
    "trial.err.badSubject": "That subject is not available.",
    "trial.err.alreadyFree": "This child already has free access.",
    "trial.err.alreadyCovered": "One of the subjects you chose is already active.",
    "trial.err.generic": "Free access could not be activated. Please try again.",
    "access.freeTrial": "Free access",
    ...
    "subj.elm": "Science",
    "subj.fizika": "Physics",
    "subj.azerbaycan_dili": "Azerbaijani",
    "subj.az_language": "Logic",
    "addchild.next": "Next",
    "addchild.back": "Back",
    ...
    "profile.err.passwordShort": "The new password must be 8 to 128 characters long.",
    "profile.err.passwordWeak":
      "The new password needs at least one capital letter and one special character (such as !, ? or #).",
    ...
    "childedit.err.creatorOnly":
      "Only the parent who created this child’s account can change the photo.",
  ...
  ru: {
    ...
    "auth.child.err.passwordTooShort": "Пароль должен содержать от 8 до 128 символов.",
    "auth.child.err.passwordWeak":
      "В пароле нужна хотя бы одна заглавная буква и один специальный символ (например, !, ? или #).",
    ...
    "auth.child.err.noLoginId":
      "У этого ребёнка ещё нет 8-значного ID для входа, поэтому пароль установить нельзя. Пожалуйста, свяжитесь с поддержкой.",
    ...
    "auth.child.err.creatorOnly":
      "Изменить пароль ребёнка может только родитель, создавший его аккаунт.",
    ...
    "reset.hint":
      "Введите новый пароль: не менее 8 символов, с одной заглавной буквой и одним специальным символом (например, !, ? или #).",
    ...
    "parent.err.password": "Пароль должен содержать от 8 до 128 символов.",
    "parent.err.passwordWeak":
      "В пароле нужна хотя бы одна заглавная буква и один специальный символ (например, !, ? или #).",
    "parent.err.tooMany":
    ...
    "link.choice.existingBody": "Подключитесь к профилю ребёнка, которого уже создал другой родитель. Повторная оплата не требуется.",
    "link.title": "Получить доступ к существующему профилю ребёнка",
    "link.subtitle":
      "Если ребёнка уже создал другой родитель, подключиться к профилю можно двумя способами. В обоих случаях доступ открывается сразу — ничего подтверждать и ждать не нужно.",
    "link.childId": "8-значный ID ребёнка",
    "link.way.credentials": "По ID и паролю ребёнка",
    "link.way.credentialsBody": "Выберите этот способ, если знаете 8-значный ID ребёнка и его пароль.",
    "link.way.code": "По ID ребёнка и коду приглашения",
    "link.way.codeBody":
      "Родитель, создавший профиль, может создать для вас код приглашения. Попросите у него код и ID ребёнка.",
    "link.code": "Код приглашения",
    "link.codeHint": "Код одноразовый и перестаёт действовать через 72 часа. Пароль в этом случае не нужен.",
    "link.request": "Получить доступ",
    "link.manage": "Управление доступом",
    "link.issue": "Создать код приглашения",
    "link.issueHint":
      "Создайте одноразовый код для другого родителя. Передайте ему код и ID ребёнка — он подключится к профилю сразу.",
    "link.issueReplaces": "Если создать новый код, предыдущий сразу перестанет работать.",
    "link.codeReady": "Передайте этот код и ID ребёнка другому родителю. Код действует 72 часа.",
    "link.codeExpires": "Действует до:",
    "link.copyCode": "Скопировать код приглашения",
    "link.revoke": "Закрыть доступ",
    "link.leave": "Отвязать ребёнка",
    "link.linked": "Совместный доступ активен",
    "link.owner": "Владелец аккаунта",
    "link.noAdults": "Другие родители пока не подключены.",
    "link.success": "Изменение сохранено.",
    "link.err.forbidden": "У вас нет прав на это действие.",
    "link.err.invalid": "Проверьте данные и повторите попытку.",
    "link.err.invalidInvite": "ID ребёнка или код приглашения неверен либо истёк.",
    "link.err.alreadyLinked": "Этот ребёнок уже привязан к вашему аккаунту.",
    "link.err.unavailable": "Это приглашение больше недоступно.",
    "link.err.creatorOnly": "Это действие доступно только владельцу аккаунта.",
    "link.err.limit": "К ребёнку можно подключить не более 4 взрослых.",
    "link.err.needsId": "Сначала необходимо создать ID для входа ребёнка.",
    ...
    "parent.child.passwordHint":
      "Не менее 8 символов, с одной заглавной буквой и одним специальным символом (например, !, ? или #). Ребёнок использует его вместе с 8-значным ID.",
    ...
    "parent.child.idCopy": "Нажмите, чтобы скопировать",
    "parent.child.idCopied": "Скопировано",
    "parent.child.idCopyA11y": "Скопировать ID для входа",
    "parent.child.idNote":
    ...
    // ---- 1-day Free Trial (migrations 139-141) ------------------------------
    "trial.hero.title": "1 день бесплатного доступа",
    "trial.hero.body":
      "Попробуйте платформу до оформления подписки. Полный доступ к 2 предметам на 24 часа — карта не нужна.",
    "trial.hero.duration": "24 часа",
    "trial.hero.p1": "24 часа безлимитного доступа",
    "trial.hero.p2": "Выберите любые 2 предмета",
    "trial.hero.p3": "Попробуйте тесты до покупки",
    "trial.hero.p4": "Результаты не влияют на баллы и рейтинг",
    "trial.cta.activate": "Активировать бесплатный доступ",
    "trial.cta.pending": "Активируем…",
    "trial.pick.title": "Выберите 2 предмета",
    "trial.pick.hint": "Для бесплатного дня можно выбрать не более 2 предметов.",
    "trial.pick.cap": "Выберите не более 2 предметов",
    "trial.pick.selected": "Выбрано",
    "trial.pick.locked": "Выберите не более 2 предметов",
    "trial.pick.aria.select": "Выбрать предмет {subject}",
    "trial.pick.aria.selected": "{subject} — выбрано",
    "trial.pick.done": "Отлично! Вы выбрали 2 предмета.",
    "trial.summary.title": "Ваш бесплатный доступ",
    "trial.summary.count": "Выбрано {n} / 2",
    "trial.summary.endsAt": "Заканчивается: {when}",
    "trial.confirm.title": "Активировать бесплатный доступ?",
    "trial.confirm.body":
      "{child} получит доступ к этим 2 предметам на 24 часа. Это доступно только один раз для каждого ребёнка.",
    "trial.confirm.ok": "Да, активировать",
    "trial.confirm.cancel": "Отмена",
    "trial.done.title": "Бесплатный доступ активен",
    "trial.done.body": "{child} теперь имеет безлимитный доступ к предметам:",
    "trial.done.next": "Начать заниматься",
    "trial.status.active": "Бесплатный доступ активен",
    "trial.status.endsIn": "Осталось:",
    "trial.badge.active": "БЕСПЛАТНЫЙ ДОСТУП",
    "trial.time.h": "ч",
    "trial.time.m": "м",
    "trial.time.s": "с",
    "trial.expired.title": "Бесплатный доступ завершён",
    "trial.expired.body":
      "Ваши 24 часа бесплатного доступа закончились. Выберите подписку, чтобы продолжить занятия.",
    "trial.expired.cta": "Посмотреть планы подписки",
    "trial.used.note": "Бесплатный доступ для этого ребёнка уже был использован.",
    "trial.note.unrated":
      "Результаты во время бесплатного доступа не влияют на баллы, рейтинг и статистику.",
    "trial.err.alreadyUsed": "Бесплатный доступ для этого ребёнка уже был использован.",
    "trial.err.tooMany": "Можно выбрать не более 2 предметов.",
    "trial.err.noSubjects": "Выберите хотя бы 1 предмет.",
    "trial.err.badSubject": "Этот предмет недоступен.",
    "trial.err.alreadyFree": "У этого ребёнка уже есть бесплатный доступ.",
    "trial.err.alreadyCovered": "Один из выбранных предметов уже активен.",
    "trial.err.generic": "Не удалось активировать бесплатный доступ. Попробуйте ещё раз.",
    "access.freeTrial": "Бесплатный доступ",
    ...
    "subj.elm": "Естественные науки",
    "subj.fizika": "Физика",
    "subj.azerbaycan_dili": "Азербайджанский язык",
    "subj.az_language": "Логика",
    "addchild.next": "Далее",
    "addchild.back": "Назад",
    ...
    "profile.err.passwordShort": "Новый пароль должен содержать от 8 до 128 символов.",
    "profile.err.passwordWeak":
      "В новом пароле нужна хотя бы одна заглавная буква и один специальный символ (например, !, ? или #).",
    ...
    "childedit.err.creatorOnly":
      "Изменить фото ребёнка может только родитель, создавший его аккаунт.",
    // ---- Payment result (payres.*) — see the az block for why it is bare.
