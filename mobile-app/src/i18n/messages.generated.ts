...
export const messages: Record<Locale, Record<string, string>> = {
  "az": {
    ...
    "addchild.field.genderHint": "İstəyə bağlıdır. Övladınızın profilində saxlanılır və ümumi statistika üçün istifadə olunur; səlahiyyətli əməkdaşlarımız onu profildə və daxili hesabatlarda görür. Girişinə, tapşırıqlarına və ya reytinqinə heç bir təsiri yoxdur.",
    "addchild.err.genderInvalid": "Cins seçimi düzgün deyil. Siyahıdan birini seçin və ya boş buraxın.",
  ...
  "en": {
    ...
    "addchild.field.genderHint": "Optional. It is stored on your child's profile and used for overall statistics; our authorised staff see it there and in internal account reports. It never affects your child's access, their tasks or their ranking.",
    "addchild.err.genderInvalid": "That gender value is not valid. Choose one from the list or leave it blank.",
  ...
  "ru": {
    ...
    "addchild.field.genderHint": "Необязательно. Хранится в профиле ребёнка и используется для общей статистики; наши уполномоченные сотрудники видят его там и во внутренних отчётах по аккаунтам. На доступ ребёнка, задания и рейтинг это никак не влияет.",
    "addchild.err.genderInvalid": "Указан недопустимый пол. Выберите вариант из списка или оставьте поле пустым.",
