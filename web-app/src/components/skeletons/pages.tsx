...
function AboutBlockSkeleton({ reversed = false }: { reversed?: boolean }) {
...
/** About page body: hero (copy + illustration), alternating copy/art blocks,
 *  values card grid (mirrors .about2-* geometry). Shared by the public /about
 *  page and the in-app parent/student About pages. */
