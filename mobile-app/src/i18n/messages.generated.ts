// AUTO-GENERATED by scripts/sync-i18n.mjs from web-app/src/i18n/messages.ts.
...
export const messages: Record<Locale, Record<string, string>> = {
  "az": {
    ...
    "subjedit.reinstateNote": "Ləğvi geri götürmək pulsuzdur: artıq ödədiyiniz dövr olduğu kimi qalır, fənn öz tarixində yenilənir və indi heç nə ödəmirsiniz.",
    "subjedit.noChanges": "Dəyişiklik yoxdur",
    "subjedit.cycleNote": "Hər fənn ayrıca ödənilir: fənni əlavə etdiyiniz gün onun öz dövrü başlayır və yalnız həmin dövrün sonunda yenilənir. Bir fənnə görə digərlərinin tarixi dəyişmir.",
    ...
    "subjedit.noteText": "Silinən fənlər öz ödənilmiş dövrlərinin sonuna qədər — ən gec {date} tarixinə qədər — aktiv qalır. Silinən fənlərə görə geri ödəniş edilmir.",
    "subjedit.noChargeNow": "İndi ödəniş alınmır — ilk ödəniş {date} tarixində olacaq.",
    "subjedit.noteLine": "{subject} {date} tarixinə qədər aktiv qalır.",
    "subjedit.noteNoRefund": "Silinən fənlərə görə geri ödəniş edilmir. Qalan fənlər öz dövrləri ilə davam edir.",
    ...
    "profile.phoneHint": "İstəyə bağlıdır. Nömrə əlavə etsəniz, hesabınızla bağlı vacib məsələlərdə sizinlə həmin nömrə vasitəsilə əlaqə saxlayırıq; sahəni boş saxlayıb istənilən vaxt silə bilərsiniz.",
    ...
    "billing.noBillingYet": "Ödəniş məlumatı hələ yoxdur. Plan aktiv olandan sonra ödəniş dövrü, növbəti ödəniş tarixi və məbləğ burada görünəcək.",
    ...
    "plan.dueTodayNote": "Fənlərin dövrləri fərqli olduğu üçün vahid dövri məbləğ göstərilmir — hər dövr ayrıca yenilənir.",
    "plan.renewals": "Yenilənmə",
    "plan.mixedNote": "Hər fənnin öz ödəniş dövrü var. Bir fənnin dövrünü dəyişmək digərlərinə təsir etmir.",
    ...
    "subjedit.planChangeNote": "İndi heç bir ödəniş alınmır — yeni dövr həmin fənnin növbəti yenilənməsindən qüvvəyə minir.",
    ...
    "supabase.notConfigured": "qurulmayıb — .env.local.example faylını .env.local edin və Supabase URL + anon açarını əlavə edin",
    "home.note": "Giriş, idarə panelləri, gündəlik tapşırıqlar, testlər və hesabatlar sonrakı mərhələlərdə əlavə olunur. Bu səhifə yalnız tətbiqin işə düşdüyünü yoxlayır.",
    ...
    "auth.child.err.passwordWeak": "Parolda ən azı bir böyük hərf və bir xüsusi simvol (!, ?, # kimi) olmalıdır.",
    "auth.child.err.nameTooLong": "Ad çox uzundur (maksimum 80 simvol).",
    "auth.child.err.passwordEqualsId": "Parol ID ilə eyni ola bilməz.",
    "auth.child.err.noLoginId": "Bu uşağın hələ 8 rəqəmli giriş ID-si yoxdur, ona görə parol təyin etmək olmur. Zəhmət olmasa dəstəklə əlaqə saxlayın.",
    ...
    "auth.child.err.creatorOnly": "Uşağın parolunu yalnız hesabı yaradan valideyn dəyişə bilər.",
    ...
    "home.heroLead": "1–11-ci siniflər üçün olimpiada hazırlığı portalı. Şagirdlər üçün abunə əsaslı platforma — valideyn idarə edir, uşaq öyrənir.",
    "home.ctaStart": "Başla",
    "home.ctaSubjects": "Fənlərə bax",
    "home.ctaOlympiads": "Olimpiadalara bax",
    "home.f1Title": "Valideyn idarəli hesablar",
    "home.f1Desc": "Valideyn qeydiyyatdan keçir və hər uşaq üçün ayrı hesab yaradır — uşaq sadə 8 rəqəmli ID ilə daxil olur.",
    "home.f2Title": "Fənn paketləri",
    "home.f2Desc": "Hər uşaq üçün fənlər — Riyaziyyat, Elm, Məntiq və İngilis dili — üzrə həftəlik, aylıq və ya illik abunə",
    ...
    "home.f4Desc": "Suallar şagirdin səviyyəsinə uyğun serverdə seçilir — həftə içi hər gün yenilənir. Davamlı irəliləyiş.",
    "about.title": "OlympIQ haqqında",
    "about.p1": "OlympIQ 1–11-ci sinif Azərbaycan şagirdlərinə olimpiadalara hazırlaşmağa və gündəlik məşqlə möhkəm təməl qurmağa kömək edir.",
    "about.p2": "Valideyn idarədədir: hər uşağın hesabını yaradır və idarə edir, fənləri seçir və irəliləyişi izləyir — hamısı bir yerdə.",
    "subjects.title": "Fənlər",
    "subjects.lead": "Övladınıza lazım olan fənləri seçin. İstənilən vaxt yenilərini əlavə edə bilərsiniz.",
    "subjects.note": "Qiymət hər fənn və hər uşaq üzrədir. Qardaş/bacı endirimi avtomatik tətbiq olunur.",
    ...
    "faq.a1": "Yalnız valideyn. Qeydiyyatdan sonra valideyn hər uşağı əlavə edir və parol təyin edir. Sistem uşağın daxil olması üçün unikal 8 rəqəmli ID verir.",
    "faq.q2": "Şagirdlər necə daxil olur?",
    "faq.a2": "Şagird 8 rəqəmli ID və valideynin təyin etdiyi parolla portala daxil olur. E-poçt tələb olunmur.",
    "faq.q3": "Qiymət necə işləyir?",
    "faq.a3": "Hər fənn və hər uşaq üçün (həftəlik, aylıq və ya illik) abunə paketi var. İlk 7 günlük ödənişsiz sınaq və eyni ailədən olan 2 və daha çox uşaq üçün avtomatik bacı/qardaş endirimi verilir.",
    "faq.q4": "Olimpiada Hazırlığı nədir?",
    "faq.a4": "Olimpiadaların mövzularına uyğun tərtib edilmiş suallara limitsiz giriş.",
    ...
    "auth.childLoginHint": "Uşaqlar 8 rəqəmli ID və valideynin təyin etdiyi parolla daxil olur.",
    ...
    "verify.resendPrompt": "Məktub gəlməyib? E-poçt ünvanınızı yazın — təsdiq linkini yenidən göndərək.",
    "verify.resend": "Linki yenidən göndər",
    "verify.resent": "Əgər bu ünvan təsdiq gözləyirsə, təsdiq linki yenidən göndərildi. Poçtunuzu və spam qovluğunu yoxlayın.",
    ...
    "reset.hint": "Hesabınız üçün yeni şifrə daxil edin: ən azı 8 simvol, bir böyük hərf və bir xüsusi simvol (!, ?, # kimi).",
    ...
    "account.err.deleteFailed": "Hesabınızı silmək alınmadı. Yenidən cəhd edin — problem təkrarlanarsa, bizimlə əlaqə saxlayın.",
    ...
    "parent.auth.registerNote": "Övladınızı əlavə etmək və idarə etmək üçün valideyn kimi qeydiyyatdan keçin.",
    "parent.err.email": "Düzgün e-poçt daxil edin.",
    "parent.err.password": "Parol 8–128 simvol arasında olmalıdır.",
    "parent.err.passwordWeak": "Parolda ən azı bir böyük hərf və bir xüsusi simvol (!, ?, # kimi) olmalıdır.",
    "parent.err.tooMany": "Həddindən çox cəhd edildi. Zəhmət olmasa bir neçə dəqiqə sonra yenidən yoxlayın.",
    "parent.err.required": "E-poçt və parolu daxil edin.",
    "parent.err.invalid": "E-poçt və ya parol yanlışdır.",
    "parent.err.createFailed": "Hesab yaradıla bilmədi. E-poçt artıq istifadədə ola bilər.",
    ...
    "link.subtitle": "Uşaq artıq başqa valideyn tərəfindən yaradılıbsa, profilə iki yoldan biri ilə qoşula bilərsiniz. Hər iki halda giriş dərhal açılır — təsdiq gözləmək lazım deyil.",
    ...
    "link.way.codeBody": "Profili yaradan valideyn sizin üçün dəvət kodu yarada bilər. Kodu və uşağın ID-sini ondan soruşun.",
    ...
    "link.issueHint": "Digər valideyn üçün birdəfəlik kod yaradın. Kodu və uşağın ID-sini ona verin — o, profilə dərhal qoşulacaq.",
    ...
    "parent.child.intro": "Uşağınızın məlumatlarını daxil edin. Plan seçdikdən sonra 8 rəqəmli giriş ID-si yaradılacaq.",
    ...
    "parent.child.passwordHint": "Ən azı 8 simvol, bir böyük hərf və bir xüsusi simvol (!, ?, # kimi). Uşağınız bunu 8 rəqəmli ID ilə birlikdə istifadə edir.",
    ...
    "parent.child.choosePlanNote": "8 rəqəmli giriş ID-si plan seçildikdən sonra yaradılır. Davam etmək üçün fənləri seçin.",
    ...
    "parent.child.idNote": "Bu ID-ni saxlayın. Uşağınız onunla və təyin etdiyiniz parolla daxil olur.",
    ...
    "trial.note.unrated": "Pulsuz giriş müddətindəki nəticələr bala, reytinqə və statistikaya təsir etmir.",
    ...
    "gate.paymentsOff": "Qısa fasilə üçün üzr istəyirik — tezliklə geri qayıdırıq. Hazırda yeni abunə və paketlər açıla bilmir. Artıq açıq olan hər şey işləməyə davam edir.",
    "gate.giveawayFree": "Hazırda pulsuz kampaniya dövrü davam edir — bütün imkanlar ödənişsiz açıqdır, ödəniş tələb olunmur.",
    "gate.giveawaySubsPaused": "Kampaniya dövründə platforma tam pulsuzdur, ona görə abunə seçimi müvəqqəti bağlıdır. Kampaniya bitdikdən sonra planları yenidən seçmək mümkün olacaq.",
    "gate.freeAccess": "Sizin üçün pulsuz giriş dövrü aktivdir — bütün abunə imkanları hazırda ödənişsiz açıqdır.",
    "gate.notInApp": "Bu dəyişiklik tətbiqdə tamamlana bilmir. Abunəliklər bu tətbiqdə idarə olunmur.",
    "iap.err.generic": "Əməliyyat tamamlana bilmədi. Zəhmət olmasa yenidən cəhd edin.",
    "iap.err.unavailable": "Bu məhsul hazırda əlçatan deyil.",
    "iap.err.alreadyActive": "Bu övladın buna girişi artıq aktivdir — yeni ödəniş tələb olunmur.",
    "iap.err.notFound": "Bu sorğu tapılmadı. Zəhmət olmasa yenidən başlayın.",
    "iap.err.mismatch": "Bu ödəniş həmin sorğuya uyğun gəlmir.",
    "iap.err.notVerified": "App Store bu ödənişi təsdiqləyə bilmədi. Məbləğ tutulubsa, dəstəyə yazın.",
    ...
    "iap.err.childGone": "Bu ödənişin aid olduğu övlad hesabı artıq mövcud deyil. Dəstəyə yazın.",
    "iap.msg.recorded": "Ödənişiniz qeydə alındı. Giriş görünmürsə, tətbiqi yenidən açın.",
    ...
    "gate.leaderboardOff": "Reytinq bölməsi hazırda əlçatan deyil — funksiya administrator tərəfindən müvəqqəti deaktiv edilib.",
    ...
    "child.contentSoon": "Gündəlik tapşırıqlar, testlər və olimpiada məşqi tezliklə burada görünəcək.",
    ...
    "child.lockedNote": "Öyrənməyə başlamaq üçün valideyninizdən fənn abunəliyini aktivləşdirməsini xahiş edin.",
    ...
    "oly5.practiceOnly": "Olimpiada cəhdləri məşq xarakterlidir — xala, faizə və reytinqə təsir etmir.",
    ...
    "parent.err.emailExists": "Bu e-poçt artıq qeydiyyatdadır. Daxil olun və ya şifrəni sıfırlayın.",
    "parent.err.noAccount": "Bu e-poçtla hesab tapılmadı. Əvvəlcə qeydiyyatdan keçin.",
    "parent.err.incompleteAccount": "Hesabınız tam qurulmayıb. Bir az sonra yenidən cəhd edin; problem davam edərsə, dəstəyə yazın.",
    "parent.err.staffAccount": "Bu e-poçt idarəetmə hesabına aiddir. Valideyn paneli üçün ayrı hesab yaradın.",
    ...
    "addchild.field.genderHint": "Övladınızın profilində saxlanılır və ümumi statistika üçün istifadə olunur; səlahiyyətli əməkdaşlarımız onu profildə və daxili hesabatlarda görür. Girişinə, tapşırıqlarına və ya reytinqinə heç bir təsiri yoxdur.",
    "addchild.err.genderRequired": "Övladınızın cinsini seçin.",
    "addchild.err.genderInvalid": "Cins seçimi düzgün deyil. Siyahıdan birini seçin.",
    "addchild.warn.genderNotSaved": "Uşaq yaradıldı, lakin cinsi yadda saxlanılmadı. Onu övladın məlumatlarını redaktə edərək təyin edə bilərsiniz.",
    ...
    "about.mission.body": "OlympIQ Azərbaycanda 1–11-ci sinif şagirdlərinə güclü akademik təməl qurmağa və olimpiadalara inamla hazırlaşmağa kömək etmək üçün yaradılıb. Məqsədimiz keyfiyyətli, müntəzəm və ölçüləbilən hazırlığı hər ailə üçün əlçatan etməkdir.",
    "about.offer.title": "Platforma nə təklif edir",
    "about.offer.body": "Valideyn idarəli uşaq hesabları, fənn üzrə abunələr (Riyaziyyat, Elm, Məntiq və İngilis dili), birdəfəlik ömürlük girişli Olimpiada Hazırlığı paketləri, gündəlik məşq və irəliləyişin izlənməsi — hamısı bir yerdə. Bütün interfeys üç dildə işləyir: Azərbaycan, ingilis və rus.",
    "about.audience.title": "Kimlər üçündür",
    "about.audience.body": "Platforma Azərbaycanda 1–11-ci sinifdə oxuyan şagirdlər və onların valideynləri üçün nəzərdə tutulub. Valideyn hesabı yaradır və idarə edir, uşaq isə sadə 8 rəqəmli ID ilə daxil olub öyrənir.",
    "about.trust.title": "Etibar və şəffaflıq",
    "about.trust.body": "Suallar sinifə uyğun serverdə seçilir, nəticələr şəffaf şəkildə göstərilir, ödənişlər yalnız valideyn tərəfindən və təhlükəsiz, təsdiqlənmiş üsulla aparılır. Uşaqların məlumatları qorunur və heç vaxt satış məqsədilə istifadə olunmur.",
    "faq.q6": "7 günlük pulsuz sınaq necə işləyir?",
    "faq.a6": "Platformada seçilən hər yeni fənn üçün şagirdə 7 günlük pulsuz sınaq müddəti verilir. Sınaq müddətində ödəniş alınmır. Sınaq bitdikdən sonra seçdiyiniz dövr üzrə ödəniş başlayır.",
    "faq.q7": "Bir ailədən olan 2 və daha çox uşaq üçün endirim varmı?",
    "faq.a7": "Bəli. Bacı/qardaş endirimi avtomatik tətbiq olunur. Valideyn qeydiyyat edərkən 2-ci uşaq üçün 10%, 3-cü və sonrakı uşaqlar üçün 15% endirim tətbiq olunur. Heç bir kod daxil etmək lazım deyil. Sistem avtomatik özü hesablayır.",
    "faq.q8": "Testlər necə keçirilir?",
    "faq.a8": "Hər test üçün suallar serverdə təsadüfi seçilir (olimpiada cəhdləri 25 sualdan ibarətdir). Şagird çətinlik səviyyəsini özü seçmir — bu, ədalətli və obyektiv qiymətləndirməni təmin edir.",
    "faq.q9": "Məlumatlarımız necə qorunur?",
    "faq.a9": "Şəxsi məlumatlar təhlükəsiz saxlanılır və yalnız xidmətin işləməsi üçün istifadə olunur. Uşaq hesabları valideynə bağlıdır, uşaqlar e-poçt və ya ödəniş məlumatı daxil etmir. Platformadakı məlumatlar 3-cü tərəfə ötürülmür.",
    "faq.q10": "Hansı dillər dəstəklənir? Necə əlaqə saxlaya bilərəm?",
    "faq.a10": "Platforma Azərbaycan (əsas), ingilis və rus dillərində işləyir. Sual və ya dəstək üçün bizimlə e-poçt və WhatsApp üzərindən əlaqə saxlaya bilərsiniz — Əlaqə səhifəsinə baxın.",
    ...
    "maintenance.body": "Sayt qısa müddətlik texniki xidmətdədir. Zəhmət olmasa bir azdan yenidən yoxlayın.",
    "contact.mapsCaption": "Bakı, Hökumət Evi — xəritədə yerimiz.",
    "contact.shortNote": "Adətən iş günləri ərzində cavablandırırıq. Sual, təklif və ya texniki dəstək üçün yazın.",
    "contact.generalTitle": "Suallar və təkliflər",
    "contact.supportTitle": "Texniki dəstək",
    "contact.supportDesc": "Platformada xəta, girişlə bağlı problem və ya ödənişdə çətinlik varsa buraya yazın.",
    ...
    "privacy.profileHint": "Hansı məlumatları topladığımızı, kimin nəyi görə bildiyini və hesabı sildikdə nə baş verdiyini burada oxuya bilərsiniz.",
    "nav.profile": "Profil",
    ...
    "profile.err.passwordWeak": "Şifrədə ən azı bir böyük hərf və bir xüsusi simvol (!, ?, # kimi) olmalıdır.",
    ...
    "carousel.i1.body": "İdarə panelindən «Uşaq əlavə et» seçin, övladınızın adını, şəhərini, məktəbini və sinfini daxil edin. Hər övlad üçün ayrıca hesab yaranır.",
    "carousel.i2.title": "Fənləri seçin və sınağı başladın",
    "carousel.i2.body": "Riyaziyyat, Elm, Məntiq və İngilis dilindən lazım olanları seçin. Hər yeni fənn 7 günlük pulsuz sınaqla başlayır — sınaq bitənə qədər ödəniş yoxdur.",
    "carousel.i3.title": "Uşaq 8 rəqəmli ID ilə daxil olur",
    "carousel.i3.body": "Plan seçiləndən sonra sistem unikal 8 rəqəmli giriş ID-si verir. Övladınız bu ID və sizin təyin etdiyiniz parolla daxil olur — e-poçt lazım deyil.",
    "carousel.i4.title": "İrəliləyişi izləyin",
    "carousel.i4.body": "Hər övladın nəticələrini, dəqiqliyini və fənn üzrə gücünü panelinizdən izləyin. Fənləri istənilən vaxt əlavə edib silə bilərsiniz.",
    "carousel.i5.title": "Olimpiada hazırlığı və dəstək",
    "carousel.i5.body": "Olimpiada paketini bir dəfə alın — övladınız ömürlük giriş əldə edir. Sualınız olsa, Əlaqə səhifəsindən bizə yazın.",
    ...
    "about.hero.body": "OlympIQ 1–11-ci sinif şagirdlərini olimpiadalara hazırlayan süni intellekt əsaslı təhsil platformasıdır. Platforma hər şagirdin nəticələrini analiz edərək onun bilik səviyyəsinə uyğun fərdi hesabatlar və inkişaf tövsiyələri hazırlayır. Gündəlik məşqlər, olimpiada formatında testlər və detallı analitika sayəsində həm şagird, həm də valideyn inkişafı aydın şəkildə izləyə bilir.",
    "about.vision.title": "Viziyonumuz",
    "about.values.title": "Bizi fərqləndirən dəyərlər",
    "about.value1.title": "Üçdilli öyrənmə",
    "about.value1.body": "Bütün interfeys Azərbaycan, ingilis və rus dilində işləyir — hər şagird özünə rahat dildə öyrənə bilər.",
    "about.value2.title": "Valideyn idarəli təhlükəsizlik",
    "about.value2.body": "Hesabları valideyn yaradır və idarə edir. Uşaqlar e-poçt və ödəniş məlumatı daxil etmir. Hər şey valideynin nəzarətindədir.",
    "about.value3.title": "Olimpiada hazırlığı",
    "about.value3.body": "Limitsiz girişli xüsusi paketlər və serverdə seçilən 25 suallıq cəhdlər real olimpiada təcrübəsi yaradır.",
    "about.value4.title": "Ölçüləbilən irəliləyiş",
    "about.value4.body": "Nəticələr, dəqiqlik və fənn üzrə potensial şəffaf göstərilir — hər addımda harada olduğunuzu görürsünüz.",
    ...
    "test.review.explAzNote": "Bu izah hələ tərcümə olunmayıb, ona görə orijinal Azərbaycan mətni göstərilir.",
    ...
    "test.report.intro": "Bu sualda nə səhvdir? Qısaca yaz — məsələn, düzgün cavab səhvdir, yazı xətası var və ya şəkil görünmür.",
    ...
    "test.report.err.tooMany": "Çox sayda bildiriş göndərdin. Bir az sonra yenidən cəhd et.",
    ...
    "childedit.err.creatorOnly": "Uşağın şəklini yalnız hesabı yaradan valideyn dəyişə bilər."
  },
  "en": {
    ...
    "subjedit.reinstateNote": "Undoing a cancellation is free: the period you have already paid for stays exactly as it was, the subject renews on its own date, and nothing is charged now.",
    "subjedit.noChanges": "No changes yet",
    "subjedit.cycleNote": "Each subject is billed on its own: its cycle starts the day you add it and renews only at the end of that cycle. Adding or dropping one subject never moves the other subjects' dates.",
    ...
    "subjedit.noteText": "Removed subjects stay active until the end of the period they are paid for — {date} at the latest. No refund is issued for removed subjects.",
    "subjedit.noChargeNow": "Nothing is charged now — the first payment is on {date}.",
    "subjedit.noteLine": "{subject} stays active until {date}.",
    "subjedit.noteNoRefund": "No refund is issued for removed subjects. The subjects you keep continue on their own cycles.",
    ...
    "profile.phoneHint": "Optional. If you add a number we use it to reach you about your account; leave the field empty to remove it at any time.",
    ...
    "billing.noBillingYet": "No billing details yet. Once a plan is active, the billing cycle, the next charge date and its amount appear here.",
    ...
    "plan.dueTodayNote": "These subjects run on different cycles, so there is no single recurring figure — each cycle renews on its own.",
    "plan.renewals": "Renewals",
    "plan.mixedNote": "Every subject has its own billing cycle. Changing one never changes another.",
    ...
    "subjedit.planChangeNote": "Nothing is charged now — the new cycle starts at that subject's next renewal.",
    ...
    "supabase.notConfigured": "not configured — copy .env.local.example to .env.local and add your Supabase URL + anon key",
    "home.note": "Auth, dashboards, daily tasks, tests and reports are added in later stages. This page only verifies the app boots.",
    ...
    "auth.child.err.passwordWeak": "The password needs at least one capital letter and one special character (such as !, ? or #).",
    ...
    "auth.child.err.noLoginId": "This child does not have an 8-digit login ID yet, so a password cannot be set. Please contact support.",
    ...
    "auth.child.err.creatorOnly": "Only the parent who created this child’s account can change the password.",
    ...
    "home.heroLead": "An olympiad preparation portal for grades 1–11. A subscription-based platform for students — the parent manages, the child learns.",
    ...
    "home.f1Desc": "The parent registers and creates a separate account for each child — the child signs in with a simple 8-digit ID.",
    "home.f2Title": "Subject packages",
    "home.f2Desc": "Weekly, monthly or yearly subscriptions per child across the subjects — Mathematics, Science, Logic and English",
    ...
    "home.f4Desc": "Questions are selected on the server to match the student's level — refreshed every weekday. Steady progress.",
    "about.title": "About OlympIQ",
    "about.p1": "OlympIQ helps Azerbaijani students in grades 1–11 prepare for olympiads and build strong fundamentals through daily practice.",
    "about.p2": "Parents stay in control: they create and manage each child's account, choose subjects, and follow progress — all in one place.",
    "subjects.title": "Subjects",
    "subjects.lead": "Choose the subjects your child needs. You can add more at any time.",
    "subjects.note": "Pricing is per subject, per child. Sibling discounts apply automatically.",
    ...
    "faq.a1": "Only the parent. After registering, the parent adds each child and sets a password. The system issues a unique 8-digit ID the student uses to log in.",
    "faq.q2": "How do students log in?",
    "faq.a2": "Students log in to the portal with their 8-digit ID and the password set by the parent. No email is required.",
    "faq.q3": "How does pricing work?",
    "faq.a3": "Each subject and each child has its own subscription package (weekly, monthly or yearly). It starts with a free 7-day trial, and an automatic sibling discount applies for 2 or more children from the same family.",
    "faq.q4": "What is Olympiad Preparation?",
    "faq.a4": "Unlimited access to questions built around olympiad topics.",
    ...
    "auth.childLoginHint": "Children log in with their 8-digit ID and a parent-set password.",
    ...
    "verify.resendPrompt": "Email never arrived? Enter your address and we'll send the confirmation link again.",
    "verify.resend": "Resend link",
    "verify.resent": "If that address is waiting to be confirmed, we've sent the link again. Check your inbox and your spam folder.",
    ...
    "reset.hint": "Enter a new password for your account: at least 8 characters, with one capital letter and one special character (such as !, ? or #).",
    ...
    "account.err.deleteFailed": "We couldn't delete your account. Please try again — if it keeps failing, get in touch with us.",
    ...
    "parent.auth.registerNote": "Register as a parent to add and manage your child.",
    "parent.err.email": "Enter a valid email.",
    "parent.err.password": "Password must be 8 to 128 characters long.",
    "parent.err.passwordWeak": "The password needs at least one capital letter and one special character (such as !, ? or #).",
    "parent.err.tooMany": "Too many attempts. Please try again in a few minutes.",
    "parent.err.required": "Enter your email and password.",
    "parent.err.invalid": "Incorrect email or password.",
    "parent.err.createFailed": "Could not create the account. The email may already be in use.",
    ...
    "link.subtitle": "If another parent already created the child, there are two ways to join the profile. Either way access opens immediately — there is nothing to approve and nothing to wait for.",
    ...
    "link.way.codeBody": "The parent who created the profile can generate an invitation code for you. Ask them for the code and the child's ID.",
    ...
    "link.issueHint": "Create a single-use code for the other parent. Give them the code and the child's ID and they join the profile straight away.",
    ...
    "parent.child.intro": "Enter your child's details. The 8-digit login ID is created after you choose a plan.",
    ...
    "parent.child.passwordHint": "At least 8 characters, with one capital letter and one special character (such as !, ? or #). Your child uses this with their 8-digit ID.",
    ...
    "parent.child.choosePlanNote": "The 8-digit login ID is created once you choose a plan. Select subjects to continue.",
    ...
    "parent.child.idNote": "Save this ID. Your child logs in with it and the password you set.",
    ...
    "trial.note.unrated": "Results during free access do not affect scores, rankings or statistics.",
    ...
    "gate.paymentsOff": "Sorry for the short interruption — we will be back soon. New subscriptions and packages cannot be opened right now. Everything you already have keeps working.",
    "gate.giveawayFree": "A free giveaway period is running — everything is unlocked at no cost, so no payment is needed right now.",
    "gate.giveawaySubsPaused": "Subscriptions are temporarily disabled because the platform is completely free during the campaign. Plans become selectable again when the campaign ends.",
    "gate.freeAccess": "A free-access period is active for you — all subscription features are unlocked at no cost right now.",
    "gate.notInApp": "This change can't be completed in the app. Subscriptions aren't managed in this app.",
    ...
    "iap.err.alreadyActive": "This child already has access to this — no new payment is needed.",
    ...
    "iap.err.notVerified": "The App Store could not confirm this payment. If you were charged, contact support.",
    ...
    "iap.err.childGone": "The child this payment was for no longer exists. Please contact support.",
    "iap.msg.recorded": "Your payment has been recorded. If access does not appear, reopen the app.",
    ...
    "gate.leaderboardOff": "Ranking is currently unavailable — the feature has been temporarily disabled by an administrator.",
    ...
    "child.contentSoon": "Daily tasks, tests and olympiad practice appear here soon.",
    ...
    "child.lockedNote": "Ask your parent to activate a subject subscription so you can start learning.",
    ...
    "oly5.practiceOnly": "Olympiad attempts are practice — they don't affect points, percentage, or ranking.",
    ...
    "parent.err.emailExists": "This email is already registered. Log in or reset your password.",
    "parent.err.noAccount": "No account found for this email. Register first.",
    "parent.err.incompleteAccount": "Your account is not fully set up. Please try again in a moment; if it persists, contact support.",
    "parent.err.staffAccount": "This email belongs to an administration account. Please create a separate account for the parent panel.",
    ...
    "addchild.field.genderHint": "It is stored on your child's profile and used for overall statistics; our authorised staff see it there and in internal account reports. It never affects your child's access, their tasks or their ranking.",
    "addchild.err.genderRequired": "Select your child's gender.",
    "addchild.err.genderInvalid": "That gender value is not valid. Choose one from the list.",
    "addchild.warn.genderNotSaved": "The child was created, but their gender was not saved. You can set it by editing the child's details.",
    ...
    "about.mission.body": "OlympIQ was created to help students in grades 1–11 across Azerbaijan build a strong academic foundation and prepare for olympiads with confidence. Our goal is to make high-quality, consistent, and measurable preparation accessible to every family.",
    "about.offer.title": "What the platform offers",
    "about.offer.body": "Parent-managed child accounts, per-subject subscriptions (Mathematics, Science, Logic, and English), one-time Olympiad Preparation packages with lifetime access, daily practice, and progress tracking — all in one place. The entire interface works in three languages: Azerbaijani, English, and Russian.",
    "about.audience.title": "Who it's for",
    "about.audience.body": "The platform is designed for students in grades 1–11 in Azerbaijan and their parents. The parent creates and manages the account, while the child simply logs in with an 8-digit ID and starts learning.",
    "about.trust.title": "Trust and transparency",
    "about.trust.body": "Questions are selected on the server by grade level, results are shown transparently, and payments are made only by the parent through a secure, verified method. Children's data is protected and never used for marketing.",
    "faq.q6": "How does the 7-day free trial work?",
    "faq.a6": "Every new subject selected on the platform gives the student a 7-day free trial. You are not charged during the trial; once it ends, billing starts for the period you chose.",
    "faq.q7": "Is there a discount for 2 or more children from the same family?",
    "faq.a7": "Yes. The sibling discount is applied automatically: 10% for the 2nd child and 15% for the 3rd and subsequent children. No code is needed — the system calculates it automatically.",
    "faq.q8": "How do the tests work?",
    "faq.a8": "Questions are selected randomly on the server for each test (olympiad attempts consist of 25 questions). Students never choose the difficulty themselves — this keeps assessment fair and objective.",
    "faq.q9": "How is our data protected?",
    "faq.a9": "Personal data is stored securely and used only to operate the service. Child accounts are linked to the parent, and children never enter email or payment details. Platform data is never shared with third parties.",
    "faq.q10": "Which languages are supported? How can I get in touch?",
    "faq.a10": "The platform works in Azerbaijani (default), English, and Russian. For questions or support, you can reach us by email or WhatsApp — see the Contact page.",
    ...
    "maintenance.body": "The site is briefly down for maintenance. Please check back in a little while.",
    "contact.mapsCaption": "Government House, Baku — our location on the map.",
    "contact.shortNote": "We usually reply during business days. Write to us with questions, suggestions, or technical support requests.",
    "contact.generalTitle": "Questions & feedback",
    "contact.supportTitle": "Technical support",
    "contact.supportDesc": "Errors on the platform, sign-in problems, or trouble with a payment.",
    ...
    "privacy.consentPost": ".",
    "privacy.profileHint": "Read what we collect, who can see what, and exactly what happens when you delete the account.",
    "nav.profile": "Profile",
    ...
    "profile.err.passwordWeak": "The new password needs at least one capital letter and one special character (such as !, ? or #).",
    ...
    "carousel.i1.body": "From your dashboard, choose “Add child” and enter your child's name, city, school, and grade. A separate account is created for each child.",
    "carousel.i2.title": "Choose subjects & start the trial",
    "carousel.i2.body": "Pick the subjects you need from Math, Science, Logic, and English. Every new subject starts with a 7-day free trial — no charge until the trial ends.",
    "carousel.i3.title": "Your child logs in with an 8-digit ID",
    "carousel.i3.body": "Once you choose a plan, the system issues a unique 8-digit login ID. Your child signs in with that ID and the password you set — no email needed.",
    "carousel.i4.title": "Track progress",
    "carousel.i4.body": "Follow each child's results, accuracy, and subject strength right from your dashboard. You can add or remove subjects at any time.",
    "carousel.i5.title": "Olympiad preparation & support",
    "carousel.i5.body": "Buy an olympiad package once and your child keeps lifetime access. Have a question? Reach us from the Contact page.",
    ...
    "about.hero.body": "OlympIQ is an AI-powered education platform that prepares students in grades 1–11 for olympiads. It analyses each student's results and builds personalised reports and improvement recommendations matched to their knowledge level. With daily practice, olympiad-format tests and detailed analytics, both the student and the parent can clearly track progress.",
    "about.vision.title": "Our vision",
    "about.values.title": "What sets us apart",
    "about.value1.title": "Trilingual learning",
    "about.value1.body": "The entire interface works in Azerbaijani, English and Russian — every student can learn in the language they find comfortable.",
    "about.value2.title": "Parent-controlled safety",
    "about.value2.body": "Accounts are created and managed by the parent. Children never enter an email or payment details. Everything stays under the parent's control.",
    "about.value3.title": "Olympiad preparation",
    "about.value3.body": "Dedicated packages with unlimited access and 25-question attempts selected on the server create a real olympiad experience.",
    "about.value4.title": "Measurable progress",
    "about.value4.body": "Results, accuracy and per-subject potential are shown transparently — you see where you stand at every step.",
    ...
    "test.review.explAzNote": "This explanation has not been translated yet, so the original Azerbaijani text is shown.",
    ...
    "test.report.intro": "What is wrong with this question? A short note is enough — for example the answer key looks wrong, there is a typo, or the image does not load.",
    ...
    "test.report.err.generic": "The report could not be sent. Please try again in a moment.",
    "test.report.err.duplicate": "You have already reported this question; it is being reviewed.",
    "test.report.err.tooMany": "You have sent a lot of reports. Please try again a little later.",
    ...
    "childedit.err.creatorOnly": "Only the parent who created this child’s account can change the photo."
  },
  "ru": {
    ...
    "subjedit.reinstateNote": "Отмена отказа бесплатна: уже оплаченный период сохраняется полностью, предмет продлевается в свою обычную дату, и сейчас с вас ничего не списывается.",
    "subjedit.noChanges": "Изменений пока нет",
    "subjedit.cycleNote": "Каждый предмет оплачивается отдельно: его период начинается в день добавления и продлевается только в конце этого периода. Добавление или удаление одного предмета не сдвигает даты остальных.",
    ...
    "subjedit.noteText": "Удалённые предметы остаются активными до конца оплаченного периода — не позднее {date}. Возврат за удалённые предметы не производится.",
    "subjedit.noChargeNow": "Сейчас списаний нет — первый платёж {date}.",
    "subjedit.noteLine": "«{subject}» остаётся активным до {date}.",
    "subjedit.noteNoRefund": "Возврат за удалённые предметы не производится. Оставшиеся предметы продолжают действовать по своим периодам.",
    ...
    "gate.giveawaySubsPaused": "Подписки временно недоступны: во время акции платформа полностью бесплатна. Планы снова можно будет выбрать после её окончания.",
    ...
    "profile.phoneHint": "Необязательно. Если укажете номер, мы будем связываться с вами по нему по вопросам аккаунта; чтобы удалить его, оставьте поле пустым.",
    ...
    "billing.noBillingYet": "Платёжных данных пока нет. Как только план станет активным, здесь появятся цикл оплаты, дата следующего списания и сумма.",
    ...
    "plan.dueTodayNote": "У предметов разные периоды, поэтому единой регулярной суммы нет — каждый период продлевается отдельно.",
    "plan.renewals": "Продление",
    "plan.mixedNote": "У каждого предмета свой период оплаты. Изменение одного не влияет на другие.",
    ...
    "subjedit.planChangeNote": "Сейчас ничего не списывается — новый период начнётся при следующем продлении этого предмета.",
    ...
    "supabase.notConfigured": "не настроено — скопируйте .env.local.example в .env.local и добавьте URL и anon-ключ Supabase",
    "home.note": "Аутентификация, панели, ежедневные задания, тесты и отчёты добавляются на следующих этапах. Эта страница лишь проверяет, что приложение запускается.",
    ...
    "auth.child.err.passwordWeak": "В пароле нужна хотя бы одна заглавная буква и один специальный символ (например, !, ? или #).",
    ...
    "auth.child.err.noLoginId": "У этого ребёнка ещё нет 8-значного ID для входа, поэтому пароль установить нельзя. Пожалуйста, свяжитесь с поддержкой.",
    ...
    "auth.child.err.creatorOnly": "Изменить пароль ребёнка может только родитель, создавший его аккаунт.",
    ...
    "home.heroLead": "Портал подготовки к олимпиадам для 1–11 классов. Платформа по подписке для школьников — родитель управляет, ребёнок учится.",
    ...
    "home.f1Desc": "Родитель регистрируется и создаёт отдельный аккаунт для каждого ребёнка — ребёнок входит по простому 8-значному ID.",
    "home.f2Title": "Предметные пакеты",
    "home.f2Desc": "Недельная, месячная или годовая подписка для каждого ребёнка по предметам — математика, естественные науки, логика и английский язык",
    ...
    "home.f4Desc": "Вопросы подбираются на сервере под уровень ученика и обновляются каждый будний день. Стабильный прогресс.",
    "about.title": "Об OlympIQ",
    "about.p1": "OlympIQ помогает ученикам 1–11 классов Азербайджана готовиться к олимпиадам и строить прочную базу через ежедневную практику.",
    "about.p2": "Родитель сохраняет контроль: создаёт и ведёт аккаунт каждого ребёнка, выбирает предметы и следит за прогрессом — всё в одном месте.",
    "subjects.title": "Предметы",
    "subjects.lead": "Выберите нужные ребёнку предметы. Добавить новые можно в любой момент.",
    "subjects.note": "Цена — за предмет и за ребёнка. Скидка за второго и последующих детей применяется автоматически.",
    ...
    "faq.a1": "Только родитель. После регистрации родитель добавляет каждого ребёнка и задаёт пароль. Система выдаёт уникальный 8-значный ID, по которому ученик входит в систему.",
    "faq.q2": "Как ученики входят в систему?",
    "faq.a2": "Ученик входит на портал по 8-значному ID и паролю, заданному родителем. Электронная почта не требуется.",
    "faq.q3": "Как работает оплата?",
    "faq.a3": "Для каждого предмета и каждого ребёнка есть свой пакет подписки (на неделю, месяц или год). Действует бесплатный 7-дневный пробный период, а для 2 и более детей из одной семьи автоматически применяется скидка для братьев и сестёр.",
    "faq.q4": "Что такое «Подготовка к олимпиадам»?",
    "faq.a4": "Безлимитный доступ к вопросам, составленным по олимпиадным темам.",
    ...
    "auth.childLoginHint": "Дети входят по 8-значному ID и паролю, заданному родителем.",
    ...
    "verify.resendPrompt": "Письмо так и не пришло? Укажите свой адрес — отправим ссылку для подтверждения ещё раз.",
    "verify.resend": "Отправить ссылку ещё раз",
    "verify.resent": "Если этот адрес ожидает подтверждения, ссылка отправлена повторно. Проверьте почту и папку «Спам».",
    ...
    "reset.hint": "Введите новый пароль: не менее 8 символов, с одной заглавной буквой и одним специальным символом (например, !, ? или #).",
    ...
    "account.err.deleteFailed": "Не удалось удалить аккаунт. Попробуйте ещё раз — если ошибка повторяется, свяжитесь с нами.",
    ...
    "parent.auth.registerNote": "Зарегистрируйтесь как родитель, чтобы добавить ребёнка и управлять его аккаунтом.",
    "parent.err.email": "Введите корректную эл. почту.",
    "parent.err.password": "Пароль должен содержать от 8 до 128 символов.",
    "parent.err.passwordWeak": "В пароле нужна хотя бы одна заглавная буква и один специальный символ (например, !, ? или #).",
    "parent.err.tooMany": "Слишком много попыток. Повторите попытку через несколько минут.",
    "parent.err.required": "Введите эл. почту и пароль.",
    "parent.err.invalid": "Неверная эл. почта или пароль.",
    "parent.err.createFailed": "Не удалось создать аккаунт. Возможно, эл. почта уже используется.",
    ...
    "link.subtitle": "Если ребёнка уже создал другой родитель, подключиться к профилю можно двумя способами. В обоих случаях доступ открывается сразу — ничего подтверждать и ждать не нужно.",
    ...
    "link.way.codeBody": "Родитель, создавший профиль, может создать для вас код приглашения. Попросите у него код и ID ребёнка.",
    ...
    "link.issueHint": "Создайте одноразовый код для другого родителя. Передайте ему код и ID ребёнка — он подключится к профилю сразу.",
    ...
    "parent.child.intro": "Введите данные ребёнка. 8-значный ID для входа создаётся после выбора плана.",
    ...
    "parent.child.passwordHint": "Не менее 8 символов, с одной заглавной буквой и одним специальным символом (например, !, ? или #). Ребёнок использует его вместе с 8-значным ID.",
    ...
    "parent.child.choosePlanNote": "8-значный ID для входа создаётся после выбора плана. Выберите предметы, чтобы продолжить.",
    ...
    "parent.child.idNote": "Сохраните этот ID. Ребёнок входит по нему и заданному вами паролю.",
    ...
    "trial.note.unrated": "Результаты во время бесплатного доступа не влияют на баллы, рейтинг и статистику.",
    ...
    "gate.paymentsOff": "Извините за короткий перерыв — мы скоро вернёмся. Сейчас нельзя открыть новые подписки и пакеты. Всё, что уже открыто, продолжает работать.",
    "gate.giveawayFree": "Сейчас идёт бесплатный акционный период — все возможности открыты бесплатно, оплата не требуется.",
    "gate.freeAccess": "Для вас активен период бесплатного доступа — все возможности подписки сейчас открыты бесплатно.",
    "gate.notInApp": "Это изменение нельзя завершить в приложении. Подписки не управляются в этом приложении.",
    "iap.err.generic": "Не удалось выполнить операцию. Пожалуйста, попробуйте ещё раз.",
    "iap.err.unavailable": "Сейчас это недоступно.",
    "iap.err.alreadyActive": "У этого ребёнка уже есть доступ к этому — новая оплата не нужна.",
    "iap.err.notFound": "Запрос не найден. Пожалуйста, начните заново.",
    "iap.err.mismatch": "Эта оплата не соответствует этому запросу.",
    "iap.err.notVerified": "App Store не смог подтвердить эту оплату. Если деньги списаны, напишите в поддержку.",
    ...
    "iap.err.childGone": "Ребёнка, для которого была эта оплата, больше не существует. Напишите в поддержку.",
    "iap.msg.recorded": "Ваша оплата записана. Если доступ не появился, перезапустите приложение.",
    ...
    "gate.leaderboardOff": "Рейтинг сейчас недоступен — функция временно отключена администратором.",
    ...
    "child.contentSoon": "Ежедневные задания, тесты и подготовка к олимпиадам появятся здесь скоро.",
    ...
    "child.lockedNote": "Попросите родителя активировать подписку на предмет, чтобы начать учиться.",
    ...
    "oly5.practiceOnly": "Попытки олимпиад — это тренировка: они не влияют на баллы, процент и рейтинг.",
    ...
    "parent.err.emailExists": "Эта эл. почта уже зарегистрирована. Войдите или сбросьте пароль.",
    "parent.err.noAccount": "Аккаунт с этой эл. почтой не найден. Сначала зарегистрируйтесь.",
    "parent.err.incompleteAccount": "Аккаунт настроен не полностью. Попробуйте ещё раз через минуту; если проблема повторяется, напишите в поддержку.",
    "parent.err.staffAccount": "Этот адрес принадлежит административному аккаунту. Для родительской панели создайте отдельный аккаунт.",
    ...
    "addchild.field.genderHint": "Хранится в профиле ребёнка и используется для общей статистики; наши уполномоченные сотрудники видят его там и во внутренних отчётах по аккаунтам. На доступ ребёнка, задания и рейтинг это никак не влияет.",
    "addchild.err.genderRequired": "Укажите пол ребёнка.",
    "addchild.err.genderInvalid": "Указан недопустимый пол. Выберите вариант из списка.",
    "addchild.warn.genderNotSaved": "Ребёнок создан, но пол не сохранился. Указать его можно, отредактировав данные ребёнка.",
    ...
    "about.mission.body": "OlympIQ создан, чтобы помочь ученикам 1–11 классов по всему Азербайджану заложить прочную академическую базу и уверенно готовиться к олимпиадам. Наша цель — сделать качественную, регулярную и измеримую подготовку доступной каждой семье.",
    "about.offer.title": "Что предлагает платформа",
    "about.offer.body": "Детские аккаунты под управлением родителя, подписки на отдельные предметы (математика, наука, логика и английский), разовые пакеты подготовки к олимпиадам с пожизненным доступом, ежедневная практика и отслеживание прогресса — всё в одном месте. Весь интерфейс работает на трёх языках: азербайджанском, английском и русском.",
    "about.audience.title": "Для кого это",
    "about.audience.body": "Платформа предназначена для учеников 1–11 классов в Азербайджане и их родителей. Родитель создаёт аккаунт и управляет им, а ребёнок просто входит по 8-значному ID и начинает учиться.",
    "about.trust.title": "Доверие и прозрачность",
    "about.trust.body": "Вопросы подбираются на сервере по классу, результаты показываются прозрачно, а оплату совершает только родитель безопасным, проверенным способом. Данные детей защищены и никогда не используются в маркетинговых целях.",
    "faq.q6": "Как работает 7-дневный бесплатный период?",
    "faq.a6": "За каждый новый предмет, выбранный на платформе, ученик получает 7-дневный бесплатный пробный период. Во время пробного периода оплата не списывается. После его окончания начинается оплата за выбранный период.",
    "faq.q7": "Есть ли скидка для 2 и более детей из одной семьи?",
    "faq.a7": "Да. Скидка для братьев и сестёр применяется автоматически: 10% на 2-го ребёнка и 15% на 3-го и последующих детей. Никакой код вводить не нужно — система рассчитывает всё сама.",
    "faq.q8": "Как проходят тесты?",
    "faq.a8": "Вопросы для каждого теста подбираются на сервере случайным образом (олимпиадная попытка состоит из 25 вопросов). Ученик не выбирает сложность сам — это обеспечивает честную и объективную оценку.",
    "faq.q9": "Как защищены наши данные?",
    "faq.a9": "Личные данные хранятся безопасно и используются только для работы сервиса. Аккаунты детей привязаны к родителю, а дети не вводят эл. почту и платёжные данные. Данные платформы не передаются третьим лицам.",
    "faq.q10": "Какие языки поддерживаются? Как с вами связаться?",
    "faq.a10": "Платформа работает на азербайджанском (основной), английском и русском языках. По вопросам и за поддержкой свяжитесь с нами по эл. почте или WhatsApp — см. страницу «Контакты».",
    ...
    "maintenance.body": "Сайт временно недоступен из-за технического обслуживания. Пожалуйста, зайдите чуть позже.",
    "contact.mapsCaption": "Дом Правительства, Баку — наше расположение на карте.",
    "contact.shortNote": "Обычно отвечаем в рабочие дни. Пишите нам по вопросам, предложениям или за технической поддержкой.",
    "contact.generalTitle": "Вопросы и предложения",
    "contact.supportTitle": "Техническая поддержка",
    "contact.supportDesc": "Ошибки на платформе, проблемы со входом или с оплатой.",
    ...
    "privacy.consentPost": ".",
    "privacy.profileHint": "Здесь можно прочитать, какие данные мы собираем, кто и что видит и что именно происходит при удалении аккаунта.",
    "nav.profile": "Профиль",
    ...
    "profile.err.passwordWeak": "В новом пароле нужна хотя бы одна заглавная буква и один специальный символ (например, !, ? или #).",
    ...
    "carousel.i1.body": "На панели выберите «Добавить ребёнка» и укажите имя, город, школу и класс ребёнка. Для каждого ребёнка создаётся отдельный аккаунт.",
    "carousel.i2.title": "Выберите предметы и начните пробный период",
    "carousel.i2.body": "Выберите нужные предметы из математики, науки, логики и английского. Каждый новый предмет начинается с 7-дневного бесплатного периода — оплата не списывается до его окончания.",
    "carousel.i3.title": "Ребёнок входит по 8-значному ID",
    "carousel.i3.body": "После выбора плана система выдаёт уникальный 8-значный ID для входа. Ребёнок входит по этому ID и заданному вами паролю — эл. почта не нужна.",
    "carousel.i4.title": "Следите за прогрессом",
    "carousel.i4.body": "Отслеживайте результаты, точность и силу по предметам каждого ребёнка прямо на панели. Предметы можно добавлять и удалять в любой момент.",
    "carousel.i5.title": "Подготовка к олимпиадам и поддержка",
    "carousel.i5.body": "Купите олимпиадный пакет один раз — и у ребёнка останется пожизненный доступ. Есть вопрос? Напишите нам со страницы «Контакты».",
    ...
    "about.hero.body": "OlympIQ — образовательная платформа на основе искусственного интеллекта, готовящая учеников 1–11 классов к олимпиадам. Платформа анализирует результаты каждого ученика и формирует персональные отчёты и рекомендации по развитию с учётом уровня знаний. Благодаря ежедневным тренировкам, тестам в олимпиадном формате и подробной аналитике и ученик, и родитель ясно видят прогресс.",
    "about.vision.title": "Наше видение",
    "about.values.title": "Что нас отличает",
    "about.value1.title": "Обучение на трёх языках",
    "about.value1.body": "Весь интерфейс работает на азербайджанском, английском и русском — каждый ученик может учиться на удобном для себя языке.",
    "about.value2.title": "Безопасность под контролем родителя",
    "about.value2.body": "Аккаунты создаёт и ведёт родитель. Дети не вводят ни электронную почту, ни платёжные данные. Всё под контролем родителя.",
    "about.value3.title": "Подготовка к олимпиадам",
    "about.value3.body": "Специальные пакеты с безлимитным доступом и подобранные на сервере попытки из 25 вопросов создают настоящий олимпиадный опыт.",
    "about.value4.title": "Измеримый прогресс",
    "about.value4.body": "Результаты, точность и потенциал по каждому предмету показаны прозрачно — на каждом шагу видно, где вы находитесь.",
    ...
    "test.review.explAzNote": "Это объяснение ещё не переведено, поэтому показан оригинальный текст на азербайджанском.",
    ...
    "test.report.intro": "Что не так с этим вопросом? Достаточно короткой заметки — например, неверный правильный ответ, опечатка или не загружается картинка.",
    ...
    "test.report.err.generic": "Не удалось отправить сообщение. Попробуй ещё раз через минуту.",
    "test.report.err.duplicate": "Ты уже сообщал об этом вопросе — он на рассмотрении.",
    "test.report.err.tooMany": "Слишком много сообщений. Попробуй немного позже.",
    ...
    "childedit.err.creatorOnly": "Изменить фото ребёнка может только родитель, создавший его аккаунт."
  }
};
