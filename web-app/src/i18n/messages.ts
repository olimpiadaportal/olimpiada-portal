...
export const messages: Record<Locale, Record<string, string>> = {
  az: {
    ...
    "cfg.interval": "Ödəniş dövrü",
    "cfg.countLabel": "Seçilmiş fənn",
    "cfg.intervalLabel": "Ödəniş dövrü",
  ...
  en: {
    ...
    "cfg.interval": "Billing period",
    "cfg.countLabel": "Subjects selected",
    "cfg.intervalLabel": "Billing period",
  ...
  ru: {
    ...
    "cfg.interval": "Период оплаты",
    "cfg.countLabel": "Выбрано предметов",
    "cfg.intervalLabel": "Период оплаты",
