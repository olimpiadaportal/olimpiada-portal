...
export const messages: Record<Locale, Record<string, string>> = {
  "az": {
    ...
    "gate.paymentsOff": "Ödənişlər müvəqqəti olaraq dayandırılıb. Yeni abunə və satınalmalar hazırda mümkün deyil.",
    ...
    "checkout.res.ok.body": "Ödənişiniz təsdiqləndi və plan aktivləşdirildi. Valideyn panelində baxa bilərsiniz.",
  ...
  "en": {
    ...
    "gate.paymentsOff": "Payments are temporarily paused. New subscriptions and purchases are unavailable right now.",
    ...
    "checkout.res.ok.body": "Your payment is confirmed and the plan is now active. You can see it in the parent panel.",
  ...
  "ru": {
    ...
    "gate.paymentsOff": "Платежи временно приостановлены. Новые подписки и покупки сейчас недоступны.",
    ...
    "checkout.res.ok.body": "Ваш платёж подтверждён, план активирован. Его можно увидеть в родительской панели.",
