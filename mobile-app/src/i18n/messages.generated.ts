...
export const messages: Record<Locale, Record<string, string>> = {
  "az": {
    ...
    "privacy.s8.statusOff": "Hazırkı vəziyyət: kart ödənişləri bankla inteqrasiya olunub, lakin hazırda dayandırılıb — heç bir məbləğ silinmir və yeni abunə başladıla bilmir. Ödənişlər açıq olduğu vaxt yalnız burada, veb saytda həyata keçirilir.",
  ...
  "en": {
    ...
    "privacy.s8.statusOff": "Current status: card payments are integrated with our bank, but charging is paused at the moment — nothing is being charged and no new subscription can be started. When payments are open they happen only here, on the website.",
  ...
  "ru": {
    ...
    "privacy.s8.statusOff": "Текущее состояние: приём карт подключён к нашему банку, но сейчас приостановлен — списаний не происходит и оформить новую подписку нельзя. Когда оплата открыта, она проходит только здесь, на сайте.",
