...
export const messages: Record<Locale, Record<string, string>> = {
  "az": {
    ...
    "home.heroLead": "Azərbaycan şagirdləri üçün abunə əsaslı təhsil platforması — valideyn idarə edir, uşaq öyrənir.",
    "home.ctaStart": "Başla",
    "home.ctaSubjects": "Fənlərə bax",
    "home.f1Title": "Valideyn idarəli hesablar",
    "home.f1Desc": "Valideyn qeydiyyatdan keçir və hər uşaq üçün hesab yaradır — uşaq sadə 8 rəqəmli ID ilə daxil olur, e-poçt lazım deyil.",
    "home.f2Title": "Fənn abunələri",
    "home.f2Desc": "Hər uşaq və hər fənn üzrə abunə — Riyaziyyat, Elm, Məntiq və İngilis dili — həftəlik, aylıq və ya illik.",
    ...
    "home.f4Desc": "Suallar sinifə uyğun serverdə seçilir — təxmin yox, davamlı irəliləyiş.",
    ...
    "subjects.lead": "Uşağınıza lazım olan fənləri seçin. İstənilən vaxt yenilərini əlavə edə bilərsiniz.",
    ...
    "pricing.sibling": "Avtomatik qardaş/bacı endirimi: 2-ci uşaq −15%, 3-cü və sonrakı −20%.",
    ...
    "faq.a2": "8 rəqəmli ID və valideynin təyin etdiyi parolla — e-poçt tələb olunmur.",
    "faq.q3": "Qiymət necə işləyir?",
    "faq.a3": "Hər fənn və hər uşaq üzrə (həftəlik, aylıq və ya illik), 7 günlük sınaq və avtomatik qardaş/bacı endirimi ilə.",
    ...
    "parent.auth.registerNote": "Uşaqlarınızı əlavə etmək və idarə etmək üçün valideyn kimi qeydiyyatdan keçin.",
    ...
    "child.loginTitle": "Şagird girişi",
    ...
    "arena.heroEyebrow": "Bugünkü raundlar",
    ...
    "pricing.siblingBody": "Birdən çox uşaq əlavə etdikdə endirim avtomatik tətbiq olunur: 2-ci uşaq üçün −15%, 3-cü və sonrakı uşaqlar üçün −20%. Heç bir kod lazım deyil.",
    ...
    "faq.a6": "Hər yeni fənn 7 günlük pulsuz sınaqla başlayır. Sınaq müddətində ödəniş alınmır; sınaq bitdikdən sonra seçdiyiniz dövr üzrə ödəniş başlayır. İstənilən vaxt ləğv edə bilərsiniz.",
    "faq.q7": "Bir neçə uşaq üçün endirim varmı?",
    "faq.a7": "Bəli. Qardaş/bacı endirimi avtomatik tətbiq olunur: 2-ci uşaq üçün −15%, 3-cü və sonrakı uşaqlar üçün −20%. Heç bir kod daxil etmək lazım deyil.",
    ...
    "faq.a9": "Şəxsi məlumatlar təhlükəsiz saxlanılır və yalnız xidmətin işləməsi üçün istifadə olunur. Uşaq hesabları valideynə bağlıdır, uşaqlar e-poçt və ya ödəniş məlumatı daxil etmir.",
    "faq.q10": "Hansı dillər dəstəklənir? Necə əlaqə saxlaya bilərəm?",
    "faq.a10": "Platforma Azərbaycan (əsas), ingilis və rus dillərində işləyir. Sual və ya dəstək üçün bizimlə e-poçt vasitəsilə əlaqə saxlaya bilərsiniz — Əlaqə səhifəsinə baxın.",
    ...
    "about.hero.body": "OlympIQ Azərbaycanda 1–11-ci sinif şagirdləri üçün abunə əsaslı təhsil platformasıdır. Valideyn idarə edir, uşaq öyrənir: fənn üzrə abunələr, gündəlik məşq və olimpiada hazırlığı bir yerdə toplanır ki, ailələr keyfiyyətli hazırlığı sadə və şəffaf şəkildə əldə etsin.",
    "about.vision.title": "Baxışımız",
    "about.vision.body": "İnanırıq ki, güclü akademik hazırlıq hər ailə üçün əlçatan olmalıdır. Məqsədimiz Azərbaycan şagirdlərinə müntəzəm məşq, obyektiv qiymətləndirmə və ölçüləbilən irəliləyiş vasitəsilə öz potensialını açmağa və olimpiadalarda inamla iştirak etməyə kömək edən etibarlı platforma qurmaqdır.",
    "about.values.title": "Bizi fərqləndirən dəyərlər",
    "about.value1.title": "Üçdilli öyrənmə",
    "about.value1.body": "Bütün interfeys Azərbaycan, ingilis və rus dilində işləyir — hər ailə özünə rahat dildə öyrənə bilər.",
    "about.value2.title": "Valideyn idarəli təhlükəsizlik",
    "about.value2.body": "Hesabları valideyn yaradır və idarə edir. Uşaqlar e-poçt və ödəniş məlumatı daxil etmir; hər şey nəzarət altındadır.",
    "about.value3.title": "Olimpiada hazırlığı",
    "about.value3.body": "Ömürlük girişli xüsusi paketlər və serverdə seçilən 25 suallıq cəhdlər real yarış təcrübəsi qurur.",
    "about.value4.title": "Ölçüləbilən irəliləyiş",
    "about.value4.body": "Nəticələr, dəqiqlik və fənn üzrə güc şəffaf göstərilir — hər addımın harada olduğunuzu görürsünüz.",
    ...
    "test.setup.topicsHint": "Heç nə seçməsən, sınaq bütün fənni əhatə edəcək.",
    "test.setup.selectAll": "Hamısını seç",
    "test.setup.clearAll": "Seçimi təmizlə",
    "test.setup.noTopics": "Bu fənn üzrə mövzu siyahısı hələ yoxdur — sınaq bütün fənn üzrə olacaq.",
    "test.setup.wholeSubject": "Bütün fənn",
    "test.setup.selectedCount": "Seçilib: {n} mövzu",
    ...
    "childedit.saved": "Dəyişikliklər yadda saxlanıldı.",
    "childedit.back": "Geri",
  ...
  "en": {
    ...
    "home.heroLead": "A subscription learning platform for Azerbaijani students — managed by parents, built for children to learn.",
    "home.ctaStart": "Get started",
    "home.ctaSubjects": "Explore subjects",
    "home.f1Title": "Parent-managed accounts",
    "home.f1Desc": "Parents register and create each child's account with a simple 8-digit ID login — no email needed for children.",
    "home.f2Title": "Subject subscriptions",
    "home.f2Desc": "Subscribe per child, per subject — Math, Science, Logic and English — weekly, monthly or yearly.",
    ...
    "home.f4Desc": "Questions selected by grade on the server — no guesswork, just steady progress.",
    ...
    "faq.a1": "Only a parent. After registering, a parent adds each child and sets a password; the system issues a unique 8-digit ID the child uses to log in.",
    ...
    "faq.a3": "Per subject, per child (weekly, monthly or yearly), with a 7-day trial and automatic sibling discounts.",
    "faq.q4": "What is Olympiad Preparation?",
    "faq.a4": "A separate one-time purchase with lifetime access and 25-question practice attempts.",
    ...
    "parent.auth.registerNote": "Register as a parent to add and manage your children.",
    ...
    "child.loginTitle": "Student login",
    ...
    "arena.heroEyebrow": "Today's rounds",
    ...
    "pricing.siblingBody": "When you add more than one child, the discount is applied automatically: −15% for the 2nd child, −20% for the 3rd and beyond. No code required.",
    ...
    "faq.a6": "Every new subject starts with a 7-day free trial. You are not charged during the trial; billing for the period you chose begins after the trial ends. You can cancel at any time.",
    "faq.q7": "Is there a discount for multiple children?",
    "faq.a7": "Yes. A sibling discount is applied automatically: −15% for the 2nd child and −20% for the 3rd and beyond. No code needs to be entered.",
    ...
    "faq.a9": "Personal data is stored securely and used only to operate the service. Child accounts are linked to the parent, and children never enter email or payment details.",
    "faq.q10": "Which languages are supported? How can I get in touch?",
    "faq.a10": "The platform works in Azerbaijani (default), English, and Russian. For questions or support, you can reach us by email — see the Contact page.",
    ...
    "about.hero.body": "OlympIQ is a subscription learning platform for students in grades 1–11 across Azerbaijan. Parents manage, children learn: per-subject subscriptions, daily practice, and olympiad preparation come together in one place, so families get high-quality preparation that is simple and transparent.",
    "about.vision.title": "Our vision",
    "about.vision.body": "We believe strong academic preparation should be within reach of every family. Our goal is to build a trusted platform that helps students in Azerbaijan unlock their potential through regular practice, objective assessment, and measurable progress — and to compete in olympiads with confidence.",
    "about.values.title": "What sets us apart",
    "about.value1.title": "Trilingual learning",
    "about.value1.body": "The entire interface works in Azerbaijani, English, and Russian — so every family can learn in the language they are most comfortable with.",
    "about.value2.title": "Parent-controlled safety",
    "about.value2.body": "Parents create and manage the accounts. Children never enter email or payment details; everything stays under a parent's control.",
    "about.value3.title": "Olympiad preparation",
    "about.value3.body": "Dedicated packages with lifetime access and server-selected 25-question attempts recreate a real competition experience.",
    "about.value4.title": "Measurable progress",
    "about.value4.body": "Results, accuracy, and subject strength are shown transparently — you always see exactly where each step stands.",
    ...
    "test.setup.topicsHint": "If you select nothing, the test covers the whole subject.",
    "test.setup.selectAll": "Select all",
    "test.setup.clearAll": "Clear selection",
    "test.setup.noTopics": "No topics are listed for this subject yet — the test will cover the whole subject.",
    "test.setup.wholeSubject": "Whole subject",
    "test.setup.selectedCount": "Selected: {n} topics",
  ...
  "ru": {
    ...
    "home.heroLead": "Образовательная платформа по подписке для учеников Азербайджана — родитель управляет, ребёнок учится.",
    "home.ctaStart": "Начать",
    "home.ctaSubjects": "Посмотреть предметы",
    "home.f1Title": "Аккаунты под управлением родителя",
    "home.f1Desc": "Родитель регистрируется и создаёт аккаунт для каждого ребёнка — вход по простому 8-значному ID, без эл. почты.",
    "home.f2Title": "Подписки на предметы",
    "home.f2Desc": "Подписка на ребёнка и предмет — математика, наука, логика и английский — еженедельно, ежемесячно или ежегодно.",
    ...
    "home.f4Desc": "Вопросы подбираются по классу на сервере — без догадок, стабильный прогресс.",
    ...
    "faq.a1": "Только родитель. После регистрации родитель добавляет каждого ребёнка и задаёт пароль; система выдаёт уникальный 8-значный ID для входа.",
    ...
    "faq.a3": "За предмет и за ребёнка (неделя, месяц или год), с 7-дневным пробным периодом и автоматическими скидками за нескольких детей.",
    "faq.q4": "Что такое «Подготовка к олимпиадам»?",
    "faq.a4": "Отдельная разовая покупка с пожизненным доступом и попытками по 25 вопросов.",
    ...
    "parent.auth.registerNote": "Зарегистрируйтесь как родитель, чтобы добавлять детей и управлять ими.",
    ...
    "child.loginTitle": "Вход для ученика",
    ...
    "arena.heroEyebrow": "Сегодняшние раунды",
    ...
    "pricing.siblingBody": "Когда вы добавляете больше одного ребёнка, скидка применяется автоматически: −15% за 2-го ребёнка и −20% за 3-го и последующих. Промокод не нужен.",
    ...
    "faq.a6": "Каждый новый предмет начинается с 7-дневного бесплатного периода. Во время него оплата не списывается; списание за выбранный период начинается после его окончания. Отменить можно в любой момент.",
    "faq.q7": "Есть ли скидка за нескольких детей?",
    "faq.a7": "Да. Скидка за нескольких детей применяется автоматически: −15% за 2-го ребёнка и −20% за 3-го и последующих. Промокод вводить не нужно.",
    ...
    "faq.a9": "Личные данные хранятся безопасно и используются только для работы сервиса. Аккаунты детей привязаны к родителю, а дети не вводят эл. почту и платёжные данные.",
    "faq.q10": "Какие языки поддерживаются? Как с вами связаться?",
    "faq.a10": "Платформа работает на азербайджанском (основной), английском и русском языках. По вопросам и за поддержкой свяжитесь с нами по эл. почте — см. страницу «Контакты».",
    ...
    "about.hero.body": "OlympIQ — это образовательная платформа по подписке для учеников 1–11 классов по всему Азербайджану. Родитель управляет, ребёнок учится: подписки на отдельные предметы, ежедневная практика и подготовка к олимпиадам собраны в одном месте, чтобы семьи получали качественную подготовку — просто и прозрачно.",
    "about.vision.title": "Наше видение",
    "about.vision.body": "Мы верим, что сильная академическая подготовка должна быть доступна каждой семье. Наша цель — создать надёжную платформу, которая помогает ученикам Азербайджана раскрыть свой потенциал через регулярную практику, объективную оценку и измеримый прогресс, а также уверенно участвовать в олимпиадах.",
    "about.values.title": "Что нас отличает",
    "about.value1.title": "Обучение на трёх языках",
    "about.value1.body": "Весь интерфейс работает на азербайджанском, английском и русском — каждая семья учится на удобном для неё языке.",
    "about.value2.title": "Безопасность под контролем родителя",
    "about.value2.body": "Аккаунты создаёт и ведёт родитель. Дети не вводят эл. почту и платёжные данные; всё остаётся под контролем родителя.",
    "about.value3.title": "Подготовка к олимпиадам",
    "about.value3.body": "Отдельные пакеты с пожизненным доступом и попытками по 25 вопросов, подобранных сервером, воссоздают настоящий соревновательный опыт.",
    "about.value4.title": "Измеримый прогресс",
    "about.value4.body": "Результаты, точность и сила по предметам показываются прозрачно — вы всегда видите, на каком этапе находится каждый шаг.",
    ...
    "test.setup.topicsHint": "Если ничего не выбрать, тест охватит весь предмет.",
    "test.setup.selectAll": "Выбрать все",
    "test.setup.clearAll": "Снять выбор",
    "test.setup.noTopics": "По этому предмету пока нет списка тем — тест будет по всему предмету.",
    "test.setup.wholeSubject": "Весь предмет",
    "test.setup.selectedCount": "Выбрано тем: {n}",
    ...
    "childedit.saved": "Изменения сохранены.",
