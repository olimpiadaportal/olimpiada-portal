...
const STRINGS: Record<Locale, Dict> = {
  az: {
    ...
    "schools.type": "Növ",
    "schools.private": "Özəl",
    "schools.public": "Dövlət",
    "schools.isPrivate": "Özəl məktəb",
    "schools.isPrivateHint": "Özəl məktəblər siyahının yuxarısında göstərilir.",
    "schools.allTypes": "Bütün növlər",
  ...
  en: {
    ...
    "schools.isPrivate": "Private school",
    "schools.isPrivateHint": "Private schools appear at the top of the list.",
    "schools.allTypes": "All types",
  ...
  ru: {
    ...
    "schools.type": "Тип",
    "schools.private": "Частная",
    "schools.public": "Государственная",
    "schools.isPrivate": "Частная школа",
    "schools.isPrivateHint": "Частные школы отображаются вверху списка.",
    "schools.allTypes": "Все типы",
