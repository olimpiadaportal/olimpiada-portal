...
- **Stage 7 DB increments 1–4 are COMPLETE on dev/staging and backported/canonical.** Remaining for Stage 7 close: extend `013` with News + Olympiad structural checks, then run a final from-zero (`001`→`012`,`014`,`015`,`013`) rebuild on dev/staging.
