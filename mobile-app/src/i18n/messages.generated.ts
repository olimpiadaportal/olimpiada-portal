...
export const messages: Record<Locale, Record<string, string>> = {
  "az": {
    ...
    "subjedit.dueNowNote": "Əlavə etdiyiniz hər fənn üçün seçdiyiniz dövrün tam qiyməti indi ödənilir və həmin dövr bu gün başlayır. Ödəniş günlərə bölünmür.",
    ...
    "poly.err.priceMoved": "Qiymət yeniləndi. Səhifəni yeniləyib yeni qiymətə baxın.",
    ...
    "sub.discount.hint": "İkinci övlad üçün 10%, üçüncü və sonrakılar üçün 15% endirim avtomatik tətbiq olunur.",
    ...
    "sub.payFirstNote": "Plan ödəniş təsdiqləndikdən sonra aktivləşəcək. Uşağınızın 8 rəqəmli giriş ID-si də həmin an yaradılacaq və valideyn panelində görünəcək.",
    "sub.trialNoChargeToday": "Bu gün heç nə ödənilmir — {days} günlük sınaq müddəti başlayır, ilk ödəniş isə o bitəndən sonra alınacaq.",
    ...
    "sub.err.priceMoved": "Qiymətlər dəyişdi. Səhifəni yeniləyib seçiminizi yenidən təsdiqləyin.",
    ...
    "pay.title": "Ödəniş",
    "pay.note": "Aşağıdakı məbləği təsdiqləyin — abunə dərhal başlayacaq və övladınızın giriş ID-si yaradılacaq.",
    "pay.payNow": "İndi ödə",
    ...
    "contact.generalDesc": "Xidmət, qiymətlər, əməkdaşlıq və ya təklifləriniz barədə bizə yazın.",
    ...
    "privacy.s5.stored": "Yuxarıdakı «Uşaq profili» cədvəlindəki hər şey: ad, soyad, şəhər, rayon, məktəb, sinif, 8 rəqəmli giriş nömrəsi, seçilmiş avatar və görünüş, məşq nəticələri (cavablar, ballar, faizlər, seriyalar, aktiv günlər, reytinq mövqeyi).",
    "privacy.s5.notCollected": "Uşaq haqqında toplamadığımız məlumatlar: doğum tarixi, e-poçt, telefon nömrəsi, ev ünvanı, məkan, sağlamlıq məlumatı, maliyyə məlumatı, kontaktlar, brauzer tarixçəsi, reklam identifikatorları və avadanlıq identifikatorları.",
    ...
    "privacy.s8.list": "Mobil tətbiqdə alışı tamamlamaq mümkün deyil: kart formu, kart məlumatlarının daxil edilməsi və ödəniş addımı tətbiqdə mövcud deyil.\nÖdənişlər yalnız veb saytda, brauzerdə və Azərbaycan manatı ilə həyata keçirilir.\nÖdəniş bankın öz səhifəsinə tam yönləndirmə ilə aparılır. Kart nömrəsi, CVV və digər kart məlumatları heç vaxt OlympIQ serverlərinə düşmür və bizdə saxlanılmır.\nVerilənlər bazasında ödənişlə bağlı yalnız məbləğ, valyuta, status və təminatçının əməliyyat nömrəsi qeyd olunur.",
    "privacy.s8.statusOff": "Hazırkı vəziyyət: kart ödənişləri bankla inteqrasiya olunub, lakin hazırda heç bir kart ödənişi alınmır — heç kimdən məbləğ silinmir. Ödənişlər açıq olduğu vaxt yalnız burada, veb saytda həyata keçirilir və mobil tətbiqlərin içində heç vaxt tamamlanmır.",
    "privacy.s8.statusOn": "Hazırkı vəziyyət: ödənişlər açıqdır və yalnız burada, veb saytda, bankın öz ödəniş səhifəsi vasitəsilə həyata keçirilir. Mobil tətbiqlərin içində alış heç vaxt tamamlanmır.",
    ...
    "about.vision.body": "Bizim vizyonumuz olimpiada hazırlığını hər bir Azərbaycan ailəsi üçün əlçatan etməkdir. Süni intellektlə fərdiləşdirilmiş təhsil, ətraflı hesabatlar və müasir öyrənmə metodlarını bir fincan qəhvə qiymətinə təqdim edərək minlərlə şagirdin gələcəyinə töhfə verməyi hədəfləyirik.",
    ...
    "checkout.intro": "Ödənişi bankın təhlükəsiz səhifəsində tamamlayacaqsınız. Kart məlumatları yalnız orada daxil edilir və bizim serverlərimizə düşmür.",
    "checkout.amount": "Ödəniləcək məbləğ",
    "checkout.payNow": "Ödənişə keç",
    "checkout.starting": "Hazırlanır…",
    "checkout.redirectNote": "İndi bankın ödəniş səhifəsinə keçəcəksiniz. Ödəniş bitdikdən sonra bura qaytarılacaqsınız.",
    ...
    "checkout.err.unavailable": "Ödəniş hazırda mümkün deyil. Bir qədər sonra yenidən cəhd edin.",
    "checkout.resume": "Ödənişi tamamla",
    "checkout.err.priceChanged": "Qiymət dəyişib. Seçiminizi yenidən nəzərdən keçirin — yeni məbləği göstərəcəyik.",
    "checkout.err.expired": "Bu ödənişin vaxtı bitib. Fənləri yenidən seçib davam edin.",
    "checkout.err.retryFromEditor": "Ödəniş alınmadı. Dəyişikliyi yenidən yadda saxlayın — planınız bu arada dəyişmiş ola bilər, ona görə məbləği yenidən hesablayacağıq.",
    "checkout.err.planChanged": "Plan başqa bir yerdə dəyişdirilib. Səhifəni yeniləyin və yenidən cəhd edin.",
    ...
    "checkout.res.ok.body": "Ödənişiniz təsdiqləndi və aldığınız giriş aktivləşdirildi. Valideyn panelində baxa bilərsiniz.",
    "checkout.res.pending.title": "Ödəniş hələ təsdiqlənməyib",
    "checkout.res.pending.body": "Bank hələ yekun cavab verməyib. Bu adətən bir neçə dəqiqə çəkir.",
    "checkout.res.pending.hint": "Zəhmət olmasa təkrar ödəniş etməyin — nəticə hazır olan kimi hesabınızda görünəcək. Bir müddət sonra da dəyişməzsə, bizimlə əlaqə saxlayın.",
    "checkout.res.failed.title": "Ödəniş baş tutmadı",
    "checkout.res.failed.body": "Məbləğ silinmədi. Kartınızı yoxlayıb yenidən cəhd edə bilərsiniz.",
  ...
  "en": {
    ...
    "subjedit.dueNowNote": "For every subject you add you pay the full price of the cycle you picked, and that cycle starts today. Nothing is split by days.",
    ...
    "poly.err.priceMoved": "The price has been updated. Refresh the page to see the new one.",
    ...
    "sub.discount.hint": "A second child gets 10% off automatically, a third and any after that 15%.",
    ...
    "sub.payFirstNote": "The plan becomes active once the payment is confirmed. Your child's 8-digit login ID is created at the same moment and appears in the parent panel.",
    "sub.trialNoChargeToday": "Nothing is charged today — a {days}-day trial starts now, and the first payment is taken only when it ends.",
    ...
    "sub.err.priceMoved": "The prices changed. Refresh the page and confirm your choice again.",
    ...
    "pay.title": "Payment",
    "pay.note": "Confirm the amount below — the subscription starts right away and your child's login ID is created.",
    "pay.payNow": "Pay now",
    ...
    "contact.generalDesc": "Questions about the service or pricing, partnership requests, suggestions and feedback.",
    ...
    "privacy.s5.stored": "Everything in the «Child profile» table above: first name, last name, city, district, school, grade, the 8-digit login number, the chosen avatar and look, and practice results (answers, points, percentages, streaks, active days, leaderboard placement).",
    "privacy.s5.notCollected": "What we never collect about a child: date of birth, email address, phone number, home address, location, health data, financial data, contacts, browsing history, advertising identifiers or hardware identifiers.",
    ...
    "privacy.s8.list": "A purchase can never be completed in the mobile app: there is no card form, no card entry and no payment step in the app at all.\nPayments happen only on the website, in a browser, in Azerbaijani manat.\nPayment uses a full redirect to the bank's own hosted page. Card numbers, CVV codes and other card details never reach OlympIQ servers and are never stored by us.\nOur database records only the amount, the currency, the status and the provider's transaction reference.",
    "privacy.s8.statusOff": "Current status: card payments are integrated with our bank, but no card payment is being taken at the moment — nobody is being charged. When charging is open it happens only here, on the website, and is never completed inside the mobile apps.",
    "privacy.s8.statusOn": "Current status: payments are open and happen only here, on the website, through the bank's own hosted payment page. A purchase is never completed inside the mobile apps.",
    ...
    "privacy.s12.never": "We never ask you for: camera, location, contacts, microphone, calendar, health, Bluetooth, or tracking permission (App Tracking Transparency). The app never opens the camera and has no way to take a photo at all. An honest note for Android: the photo-picker component we use declares camera and storage permissions in its own manifest, so you may see them listed in the phone's App info screen — the app never uses them and never shows you a camera prompt.",
    ...
    "about.vision.body": "Our vision is to make olympiad preparation accessible to every family in Azerbaijan. By delivering AI-personalised learning, detailed reports and modern study methods for the price of a cup of coffee, we aim to contribute to the future of thousands of students.",
    ...
    "checkout.intro": "You will finish this payment on your bank's secure page. Card details are entered there only and never reach our servers.",
    "checkout.amount": "Amount due",
    "checkout.payNow": "Continue to payment",
    "checkout.starting": "Preparing…",
    "checkout.redirectNote": "You are about to be taken to the bank's payment page. You will be brought back here once the payment is finished.",
    ...
    "checkout.err.unavailable": "Payment is not available right now. Please try again shortly.",
    "checkout.resume": "Complete this payment",
    "checkout.err.priceChanged": "The price has changed. Please review your selection — we will show you the new amount.",
    "checkout.err.expired": "This payment has expired. Choose the subjects again to continue.",
    "checkout.err.retryFromEditor": "The payment did not go through. Save the change again — your plan may have moved in the meantime, so we will re-calculate the amount.",
    "checkout.err.planChanged": "The plan was changed somewhere else. Refresh the page and try again.",
    "checkout.err.tooMany": "Too many attempts. Please check again in a few minutes.",
    "checkout.res.ok.title": "Payment confirmed",
    "checkout.res.ok.body": "Your payment is confirmed and what you bought is now active. You can see it in the parent panel.",
    "checkout.res.pending.title": "Payment not confirmed yet",
    "checkout.res.pending.body": "The bank has not given a final answer yet. This usually takes a few minutes.",
    "checkout.res.pending.hint": "Please do not pay again — the result will appear in your account as soon as it is ready. If it still has not after a while, get in touch with us.",
    "checkout.res.failed.title": "Payment did not go through",
    "checkout.res.failed.body": "No money was taken. You can check your card and try again.",
  ...
  "ru": {
    ...
    "subjedit.dueNowNote": "За каждый добавленный предмет сейчас списывается полная стоимость выбранного периода, и период начинается сегодня. Оплата не делится по дням.",
    ...
    "poly.err.priceMoved": "Цена обновилась. Обновите страницу, чтобы увидеть новую.",
    ...
    "plan.renewalLine.weekly": "Недельные предметы продлеваются каждую неделю на {total} {currency}.",
    "plan.renewalLine.monthly": "Месячные предметы продлеваются каждый месяц на {total} {currency}.",
    "plan.renewalLine.yearly": "Годовые предметы продлеваются каждый год на {total} {currency}.",
    ...
    "sub.discount.hint": "За второго ребёнка автоматически 10%, за третьего и последующих — 15%.",
    ...
    "sub.payFirstNote": "План станет активным после подтверждения оплаты. Тогда же будет создан 8-значный логин ребёнка, и он появится в родительской панели.",
    "sub.trialNoChargeToday": "Сегодня ничего не списывается — начинается пробный период на {days} дн., а первый платёж будет взят только после его окончания.",
    ...
    "sub.err.priceMoved": "Цены изменились. Обновите страницу и подтвердите выбор ещё раз.",
    ...
    "pay.title": "Оплата",
    "pay.note": "Подтвердите сумму ниже — подписка начнётся сразу, и для ребёнка будет создан ID для входа.",
    "pay.payNow": "Оплатить",
    ...
    "contact.generalDesc": "Вопросы о сервисе и ценах, сотрудничество, предложения и отзывы.",
    ...
    "privacy.s5.stored": "Всё, что указано в таблице «Профиль ребёнка» выше: имя, фамилия, город, район, школа, класс, 8-значный номер для входа, выбранный аватар и оформление, а также результаты занятий (ответы, баллы, проценты, серии, активные дни, место в рейтинге).",
    "privacy.s5.notCollected": "Что мы о ребёнке не собираем: дату рождения, адрес электронной почты, номер телефона, домашний адрес, геолокацию, данные о здоровье, финансовые данные, контакты, историю браузера, рекламные и аппаратные идентификаторы.",
    ...
    "privacy.s8.list": "Завершить покупку в мобильном приложении невозможно: в нём нет ни формы карты, ни ввода данных карты, ни шага оплаты.\nОплата возможна только на сайте, в браузере, в азербайджанских манатах.\nОплата проходит полным перенаправлением на собственную страницу банка. Номер карты, код CVV и другие данные карты никогда не попадают на серверы OlympIQ и у нас не хранятся.\nВ нашей базе фиксируются только сумма, валюта, статус и номер операции у провайдера.",
    "privacy.s8.statusOff": "Текущее состояние: приём карт подключён к нашему банку, но сейчас оплата картой не взимается — ни с кого не списываются средства. Когда оплата открыта, она проходит только здесь, на сайте, и никогда не завершается внутри мобильных приложений.",
    "privacy.s8.statusOn": "Текущее состояние: оплата открыта и проходит только здесь, на сайте, через собственную платёжную страницу банка. Внутри мобильных приложений покупка не завершается никогда.",
    ...
    "about.vision.body": "Наше видение — сделать подготовку к олимпиадам доступной каждой азербайджанской семье. Предлагая персонализированное обучение на основе ИИ, подробные отчёты и современные методы по цене чашки кофе, мы хотим внести вклад в будущее тысяч школьников.",
    ...
    "checkout.intro": "Оплату вы завершите на защищённой странице банка. Данные карты вводятся только там и на наши серверы не попадают.",
    "checkout.amount": "Сумма к оплате",
    "checkout.payNow": "Перейти к оплате",
    "checkout.starting": "Подготовка…",
    "checkout.redirectNote": "Сейчас вы перейдёте на страницу оплаты банка. После завершения оплаты вы вернётесь сюда.",
    ...
    "checkout.err.unavailable": "Оплата сейчас недоступна. Попробуйте немного позже.",
    "checkout.resume": "Завершить оплату",
    "checkout.err.priceChanged": "Цена изменилась. Проверьте свой выбор — мы покажем новую сумму.",
    "checkout.err.expired": "Срок этого платежа истёк. Выберите предметы заново, чтобы продолжить.",
    "checkout.err.retryFromEditor": "Платёж не прошёл. Сохраните изменение заново — ваш план мог измениться, поэтому мы пересчитаем сумму.",
    "checkout.err.planChanged": "План был изменён в другом месте. Обновите страницу и попробуйте снова.",
    ...
    "checkout.res.ok.body": "Ваш платёж подтверждён, купленный доступ активирован. Его можно увидеть в родительской панели.",
    "checkout.res.pending.title": "Платёж ещё не подтверждён",
    "checkout.res.pending.body": "Банк пока не дал окончательного ответа. Обычно это занимает несколько минут.",
    "checkout.res.pending.hint": "Пожалуйста, не платите повторно — результат появится в вашем аккаунте, как только будет готов. Если через некоторое время ничего не изменится, свяжитесь с нами.",
    "checkout.res.failed.title": "Платёж не прошёл",
    "checkout.res.failed.body": "Деньги не списаны. Проверьте карту и попробуйте ещё раз.",
