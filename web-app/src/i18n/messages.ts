...
export const messages: Record<Locale, Record<string, string>> = {
  az: {
    ...
    "link.codeReady": "Bu kodu digər valideynlə paylaşın. Kod 72 saat ərzində etibarlıdır.",
    "link.approve": "Təsdiq et",
    "link.reject": "Rədd et",
  ...
  en: {
    ...
    "link.request": "Request access",
    "link.pending": "Waiting for approval",
    "link.manage": "Manage access",
    "link.issue": "Create invitation code",
    "link.codeReady": "Share this code with the other parent. It expires in 72 hours.",
  ...
  ru: {
    ...
    "link.request": "Запросить доступ",
    "link.pending": "Ожидает подтверждения",
    "link.manage": "Управление доступом",
    "link.issue": "Создать код приглашения",
    "link.codeReady": "Передайте этот код другому родителю. Он действует 72 часа.",
    "link.approve": "Подтвердить",
    "link.reject": "Отклонить",
