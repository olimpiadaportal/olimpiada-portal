...
export const SITE_CONTENT_REGISTRY: SiteContentEntry[] = [
  ...
  },
  {
    ...
    defaults: {
      ...
      en: "The AI technology analyses each student's results, identifies strong topics and those that need work, and prepares personalised reports and learning recommendations. Every student grows according to their own knowledge level and needs, learns more efficiently and moves toward their goals step by step.",
      ru: "Технология искусственного интеллекта анализирует результаты каждого ученика, определяет сильные темы и темы, требующие развития, и готовит персональные отчёты и рекомендации по обучению. Так каждый ученик развивается в соответствии со своим уровнем и потребностями, учится эффективнее и шаг за шагом приближается к целям.",
    },
  },
  {
    key: "about2.hero.p3",
    ...
    multiline: true,
    defaults: {
      az: "Platformada riyaziyyat, elm, məntiq və ingilis dili üzrə minlərlə tapşırıq, olimpiada formatında sınaqlar və gündəlik məşq imkanları təqdim olunur. Suallar şagirdlərin sinif səviyyəsinə və seçilən mövzulara uyğun hazırlanır, müntəzəm məşq isə biliklərin möhkəmlənməsinə və olimpiada bacarıqlarının inkişafına kömək edir.",
      en: "The platform offers thousands of tasks in mathematics, science, logic and English, olympiad-format mock tests and daily practice. Questions are matched to the student's grade level and chosen topics, while regular practice consolidates knowledge and develops olympiad skills.",
      ru: "Платформа предлагает тысячи заданий по математике, естественным наукам, логике и английскому языку, испытания в олимпиадном формате и ежедневные тренировки. Вопросы подбираются под класс ученика и выбранные темы, а регулярная практика закрепляет знания и развивает олимпиадные навыки.",
    },
  },
  {
    key: "about2.hero.p4",
    ...
    multiline: true,
    defaults: {
      az: "OlympIQ-də hesablar valideyn tərəfindən idarə olunur. Valideyn övladlarını əlavə edir, fənn seçimlərini və abunələri idarə edir, şagird isə sadə və təhlükəsiz giriş sistemi vasitəsilə yalnız öyrənməyə fokuslanır. Bu yanaşma həm təhlükəsizliyi təmin edir, həm də valideynlərə hazırlıq prosesini rahat şəkildə idarə etmək imkanı yaradır.",
      en: "On OlympIQ, accounts are managed by the parent. The parent adds their children and manages subject choices and subscriptions, while the student focuses purely on learning through a simple, safe sign-in system. This approach ensures safety and lets parents comfortably steer the preparation process.",
      ru: "В OlympIQ аккаунтами управляет родитель: он добавляет детей, управляет выбором предметов и подписками, а ученик через простую и безопасную систему входа сосредоточен только на учёбе. Такой подход обеспечивает безопасность и позволяет родителям удобно вести процесс подготовки.",
    },
  },
  {
    key: "about2.b1.body",
    ...
    multiline: true,
    defaults: {
      az: "Şagirdlər sinif səviyyəsinə uyğun suallarla hər gün məşq edir. Kiçik, amma davamlı addımlar olimpiadanın tələb etdiyi möhkəm təməli qurur.",
      en: "Students practise every day with questions matched to their grade level. Small but steady steps build the solid foundation an olympiad demands.",
      ru: "Ученики каждый день тренируются на вопросах своего уровня. Маленькие, но постоянные шаги строят прочный фундамент, которого требует олимпиада.",
    },
  },
  {
    key: "about2.b2.body",
    ...
    multiline: true,
    defaults: {
      az: "Valideyn hər uşağın hesabını yaradır, fənn abunələrini seçir və irəliləyişi bir paneldən izləyir. Uşaq isə sadəcə 8 rəqəmli ID ilə platformaya daxil olur.",
      en: "The parent creates each child's account, picks subject subscriptions and tracks progress from one panel. The child simply signs in to the platform with an 8-digit ID.",
      ru: "Родитель создаёт аккаунт каждого ребёнка, выбирает подписки по предметам и следит за прогрессом с одной панели. Ребёнок просто входит на платформу по 8-значному ID.",
    },
  },
  {
    key: "about2.b3.body",
    ...
    multiline: true,
    defaults: {
      az: "Hər cəhddə süni intellekt 25 sualı avtomatik seçir — çətinliyi heç kim özü müəyyən etmir. Paketlər bir dəfə alınır və limitsiz giriş imkanı verir.",
      en: "On every attempt the AI automatically selects 25 questions — nobody picks the difficulty themselves. Packages are bought once and give unlimited access.",
      ru: "В каждой попытке искусственный интеллект автоматически подбирает 25 вопросов — сложность никто не выбирает сам. Пакеты покупаются один раз и дают безлимитный доступ.",
    },
  },
  {
    key: "about2.b4.body",
    ...
    multiline: true,
    defaults: {
      az: "Nəticələr, fənn üzrə güclü və zəif tərəflər, gündəlik ardıcıllıq — hamısı aydın qrafiklərdə təqdim olunur. Valideyn uşağın hansı tapşırıqları etdiyini və nəticələrini aydın görür.",
      en: "Results, strengths and weaknesses per subject, the daily streak — everything is presented in clear charts. The parent sees exactly which tasks the child did and how they scored.",
      ru: "Результаты, сильные и слабые стороны по предметам, ежедневная серия — всё в наглядных графиках. Родитель ясно видит, какие задания выполнял ребёнок и с какими результатами.",
    },
  },
  {
    key: "about2.b5.body",
    ...
    multiline: true,
    defaults: {
      az: "Uşaq hesabları e-poçtsuz işləyir və heç vaxt ödəniş edə bilmir — bütün ödənişlər yalnız valideyn hesabından aparılır. Uşaq məlumatları qorunur və icazəsiz marketinq üçün istifadə olunmur.",
      en: "Child accounts work without email and can never make a payment — every payment happens only from the parent account. Children's data is protected and never used for unauthorised marketing.",
      ru: "Детские аккаунты работают без электронной почты и никогда не могут платить — все платежи выполняются только с родительского аккаунта. Данные детей защищены и не используются для несанкционированного маркетинга.",
    },
  },
  {
    key: "about2.v1.body",
    ...
    multiline: true,
    defaults: {
      az: "Keyfiyyətli olimpiada hazırlığını hər ailə üçün əlçatan etmək. Müntəzəm və ölçüləbilən hazırlıq — hər şagird üçün.",
      en: "Make quality olympiad preparation accessible for every family. Regular, measurable preparation — for every student.",
      ru: "Сделать качественную подготовку к олимпиадам доступной каждой семье. Регулярная и измеримая подготовка — для каждого ученика.",
    },
  },
  {
    key: "about2.v2.body",
    ...
    multiline: true,
    defaults: {
      az: "Fənlər üzrə abunələr (Riyaziyyat, Elm, Məntiq, İngilis dili), Olimpiada Hazırlığı paketləri, gündəlik sınaq və irəliləyiş analitikası.",
      en: "Subject subscriptions (Mathematics, Science, Logic, English), Olympiad Preparation packages, daily mock rounds and progress analytics.",
      ru: "Подписки по предметам (математика, естественные науки, логика, английский), пакеты олимпиадной подготовки, ежедневные испытания и аналитика прогресса.",
    },
  },
  {
    key: "about2.v3.body",
    ...
    multiline: true,
    defaults: {
      az: "1–11-ci sinifdə oxuyan şagirdlər və onların valideynləri üçün. Valideyn hesabı idarə edir, uşaq öyrənməyə fokuslanır.",
      en: "For students in grades 1–11 and their parents. The parent manages the account; the child focuses on learning.",
      ru: "Для учеников 1–11 классов и их родителей. Родитель управляет аккаунтом, ребёнок сосредоточен на учёбе.",
    },
  },
  {
    key: "about2.v4.body",
    ...
    multiline: true,
    defaults: {
      az: "Suallar serverdə seçilir, nəticələr şəffaf göstərilir, ödənişlər isə təhlükəsiz üsulla yalnız valideyn tərəfindən aparılır.",
      en: "Questions are selected on the server, results are shown transparently, and payments are secure and parent-only.",
      ru: "Вопросы подбираются на сервере, результаты показываются прозрачно, а платежи безопасны и доступны только родителям.",
    },
  },
  {
    key: "about2.team.title",
    section: "landing",
    menu: "about",
    defaults: {
      az: "Komandamız",
  ...
  },
  {
    ...
    multiline: true,
    defaults: {
      az: "OlympIQ layihəsinin arxasında duran komanda və hüquqi məlumatlar.",
      en: "The team and legal information behind the OlympIQ project.",
      ru: "Команда и юридическая информация проекта OlympIQ.",
    },
  },
  {
    key: "about2.team.body",
    section: "landing",
    menu: "about",
    multiline: true,
    defaults: {
      az: "OlympIQ layihəsi Kamil Piriyev (VÖEN: 6300091352) və tərəfdaşları tərəfindən həyata keçirilir.",
      en: "The OlympIQ project is implemented by Kamil Piriyev (Tax Identification Number: 6300091352) and his partners.",
      ru: "Проект OlympIQ реализуется Камилем Пириевым (ИНН: 6300091352) и его партнёрами.",
    },
  },
  {
    key: "about2.team.addrLabel",
    section: "landing",
    menu: "about",
    defaults: {
      az: "Hüquqi ünvan",
  ...
  {
    key: "about2.team.addrValue",
    section: "landing",
    menu: "about",
    multiline: true,
    defaults: {
      az: "Azərbaycan Respublikası,\nLerik rayonu,\nPeştətük kəndi",
      en: "Peshtatuk village,\nLerik District,\nRepublic of Azerbaijan",
