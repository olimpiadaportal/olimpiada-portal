...
export const messages: Record<Locale, Record<string, string>> = {
  "az": {
    ...
    "lb.provisionalHint": "Rəsmi yer üçün ən azı {q} sual və {a} raund lazımdır.",
    "lb.myRank.provisional": "Nəticəniz ilkindir — rəsmi yer üçün: {q}/{mq} sual, {a}/{ma} raund.",
  ...
  "en": {
    ...
    "lb.provisionalHint": "An official rank needs at least {q} questions and {a} rounds.",
    "lb.myRank.provisional": "Your result is provisional — for an official rank: {q}/{mq} questions, {a}/{ma} rounds.",
  ...
  "ru": {
    ...
    "lb.provisionalHint": "Для официального места нужно минимум {q} вопросов и {a} раундов.",
    "lb.myRank.provisional": "Ваш результат предварительный — для официального места: {q}/{mq} вопросов, {a}/{ma} раундов.",
