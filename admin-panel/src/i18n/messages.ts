...
export const messages: Record<Locale, Record<string, string>> = {
  az: {
    ...
    "wallpaper.saved": "Yadda saxlanıldı — divar kağızı siyahıya əlavə olundu.",
    "wallpaper.listError":
      "Divar kağızı siyahısı yüklənə bilmədi. Səhifəni yeniləyin və ya server loglarını yoxlayın.",
  ...
  en: {
    ...
    "wallpaper.saved": "Saved — the wallpaper was added to the list.",
    "wallpaper.listError":
      "The wallpaper list could not be loaded. Refresh the page or check the server logs.",
  ...
  ru: {
    ...
    "wallpaper.saved": "Сохранено — обои добавлены в список.",
    "wallpaper.listError":
      "Не удалось загрузить список обоев. Обновите страницу или проверьте логи сервера.",
